      ...
      <div className="bg-gradient-to-br from-white to-[#b4b1d5]">
         ...
         <div
            ...
            <h1 className="font-extrabold text-3xl mb-2">
               MatchPoint AI Privacy Policy
            </h1>
            <h2 className="font-bold text-2xl mb-2">1. Introduction</h2>

            <p className="mb-2">
               Welcome to MatchPoint AI (&quot;we&quot;, &quot;our&quot;,
               &quot;us&quot;). This Privacy Policy describes how we collect,
               use, process, and protect your personal information when you use
               our generative AI marketing content platform (the
               &quot;Service&quot;).
            </p>

            <p className="mb-2">
               By using MatchPoint AI, you agree to the terms of this Privacy
               Policy.
            </p>
            <div className="">
            ...
            <p className="mb-2">
               We collect data related to your interaction with our platform:
            </p>
            ...
            <h2 className="font-bold text-2xl mb-2">
               4. Data Processing for AI Training
            </h2>

            <ul className="list-disc pl-11 mb-2">
               <li className="">
                  User-submitted data and generated content may be anonymized
                  and used to improve our AI models.
               </li>
               <li className="">
                  Sensitive or personally identifiable information is stripped
                  from training data.
               </li>
            </ul>
            ...
            <ul className="list-disc pl-11 mb-2">
               <li>
                  Email:{" "}
                  <a href="mailto:legal@matchpointai.com">
                     legal@matchpointai.com
                  </a>
               </li>
               <li>
                  Mailing Address: 18459 Pines Boulevard, Ste. 507, Pembroke
                  Pines, FL 33029
               </li>
            </ul>
