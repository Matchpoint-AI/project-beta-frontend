...
const Campaign = () => {
   ...
   useEffect(() => {
      ...
      const fetchBrandData = async () => {
         const response = await fetch(
            endpointUrl + "/api/v1/data/get/complex?query_kind=brand_data",
            {
               method: "GET",
               headers: {
         ...
         if (data.length > 0) {
            setCampaignInfo((prev) => ({
               ...prev,
               brandLogo:
                  data[0].logo !== undefined ? data[0].logo.file : undefined,
            }));
            setBusinessInfo({
   ...
   const customComponentData = [
      ...
      },
      {
         ...
         subtitle:
            "We'll show this in your campaign with pictures and captions.",
      },
      {
            ...
            <div className="flex lg:flex-row w-full md:w-[95%] lg:w-[1024px] flex-col mx-auto gap-4">
               ...
               <div className="w-full lg:w-2/3 grow lg:grow-0">
                  <CustomComponent
                     ...
                     {currentStep === 1 && (
                        <PurposeForm handleNext={handleNext} />
                     )}
                     {currentStep === 2 && (
                        <ServiceForm
