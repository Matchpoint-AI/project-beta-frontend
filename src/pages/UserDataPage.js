...
export default function UserDataPage() {
  ...
  var _b = useState(false),
    openContentWin = _b[0],
    setOpenContentWin = _b[1];
  var _c = useState([]),
    content = _c[0],
    setContent = _c[1];
  var _d = useFetchThreadMessages(),
    messages = _d[0],
    openThreadWin = _d[1],
    setOpenThreadWin = _d[2],
    fetchMessages = _d[3],
    addMessage = _d[4],
    popMessage = _d[5];
  var handleOpenWindow = function (id) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(''.concat(endpointUrl, '/api/v1/users/campaign/').concat(id), {
                headers: {
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsx(CampaignContentWin, {
        open: openContentWin,
        onClose: function () {
          return setOpenContentWin(false);
        },
        content: content,
      }),
