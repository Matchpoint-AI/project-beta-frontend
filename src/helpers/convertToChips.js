...
var convertToChipsArray = function (attribute) {
    if (typeof attribute[0] === 'object') {
        ...
        return attribute.map(function (chip, index) {
            var _a;
            return (__assign(__assign({}, chip), { id: (_a = chip.id) !== null && _a !== void 0 ? _a : index }));
        });
    }
    return attribute === null || attribute === void 0 ? void 0 : attribute.filter(function (v) { return !!v && typeof v === 'string' && v.trim() !== ''; }).map(function (value, index) { return ({
        id: index,
        label: value,
        selected: true,
    }); });
