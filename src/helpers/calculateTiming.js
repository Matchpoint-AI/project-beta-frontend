...
export var displayPeriod = function (startDate, duration) {
    ...
    if (!duration || duration === '')
        return 'Timing not selected';
    try {
        var _b = startDate.split('/').map(Number), month = _b[0], day = _b[1], year = _b[2];
        ...
        if (durationParts.length < 2) {
            ...
            if (isNaN(durationValue_1))
                return 'Timing not selected';
            var end_1 = new Date(start);
            end_1.setDate(start.getDate() + durationValue_1 * 7);
            var now_1 = new Date();
            var isCompleted_1 = now_1 >= end_1;
            var weekNumber_1 = isCompleted_1 ? durationValue_1 : calculateWeekNumber(start, durationValue_1);
            ...
            if (startYear_1 === endYear_1) {
                if (start.getMonth() === end_1.getMonth()) {
                    dateRange_1 = "".concat(startMonth_1, " ").concat(startDayMonth_1, " - ").concat(endDayMonth_1, ", ").concat(startYear_1);
                }
                else {
                    dateRange_1 = "".concat(startMonth_1, " ").concat(startDayMonth_1, " - ").concat(endDayMonth_1, ", ").concat(startYear_1);
                }
                ...
                dateRange_1 = "".concat(startMonth_1, " ").concat(startDayMonth_1, ", ").concat(startYear_1, " - ").concat(endDayMonth_1, ", ").concat(endYear_1);
            }
            if (isCompleted_1 || weekNumber_1 <= 0) {
                return "".concat(durationValue_1, " weeks, ").concat(dateRange_1);
            }
            else {
                return "Week ".concat(weekNumber_1, " of ").concat(durationValue_1, ", ").concat(dateRange_1);
            }
        }
        var durationValue = Number(durationParts[0]);
        var durationUnit = ((_a = durationParts[1]) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || 'weeks';
...
var getOrdinalSuffix = function (day) {
    if (day > 3 && day < 21)
        return "".concat(day, "th"); // Covers 11-20
    switch (day % 10) {
        case 1:
...
export var displayDuration = function (startDate, duration) {
    ...
    if (typeof duration === 'number') {
        ...
        durationUnit = ((_a = durationParts[1]) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || 'weeks';
    }
    // Calculate the end date
    var end;
    if (durationUnit === 'weeks' || durationUnit === 'week') {
    ...
    var formattedYear = startYear === endYear ? startYear : "".concat(startYear, " - ").concat(endYear);
...
var getGMTOffset = function (timeZone) {
    ...
    try {
        ...
        var gmtPart = (_a = parts.find(function (part) { return part.type === 'timeZoneName'; })) === null || _a === void 0 ? void 0 : _a.value;
...
export var getPostingSchedule = function (numPosts) {
    ...
    if (numPosts === 1)
        return "".concat(possibleTimes[1], " ").concat(userTimeZone);
    if (numPosts === 2)
        return "".concat(possibleTimes[0], ", ").concat(possibleTimes[3], " ").concat(userTimeZone);
    if (numPosts === 3)
        return "".concat(possibleTimes[0], ", ").concat(possibleTimes[2], ", ").concat(possibleTimes[3], " ").concat(userTimeZone);
    if (numPosts === 4)
        return "".concat(possibleTimes[0], ", ").concat(possibleTimes[1], ", ").concat(possibleTimes[2], ", ").concat(possibleTimes[3], " ").concat(userTimeZone);
...
export var getPostingScheduleArray = function (numPosts) {
    ...
    if (numPosts === 1)
        return ["".concat(possibleTimes[1], " ").concat(userTimeZone)];
    if (numPosts === 2)
        return ["".concat(possibleTimes[0], " ").concat(userTimeZone), "".concat(possibleTimes[3], " ").concat(userTimeZone)];
    if (numPosts === 3)
        return [
    ...
    // For 5-6 posts, include all available time slots
    return possibleTimes.map(function (time) { return "".concat(time, " ").concat(userTimeZone); });
};
