    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 6:
          ...
          doc.setFont('helvetica', 'normal');
          yOffset = 70;
          brandProfile.values.forEach(function (value, index) {
            ...
            return __generator(this, function (_h) {
              switch (_h.label) {
                ...
                case 8:
                  ...
                  doc.setFontSize(10);
                  textWidth = 180;
                  data = removeNewlines(post.text);
                  finalText = cleanAndStripEmojis(data);
...
var convertColors = function (colors) {
  return __awaiter(void 0, void 0, void 0, function () {
    var url, requestBody, response, data, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 4:
          error_2 = _a.sent();
          console.error('Error fetching the converted colors:', error_2);
          return [3 /*break*/, 5];
        case 5:
          return [2 /*return*/];
      }
