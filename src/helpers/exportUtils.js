...
var fetchImageAsDataURL = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var response, blob;
...
export var fetchAndCreatePDF = function (id, endpointUrl, token) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 5, , 6]);
                return [4 /*yield*/, fetch("".concat(endpointUrl, "/api/v1/getPdfData?").concat(params), {
                        method: 'GET',
            ...
            case 3:
                ...
                if (!data)
                    return [2 /*return*/];
                return [4 /*yield*/, createBrandProfilePDF(data.client_request, data.brand_profile, data.campaign_brief)];
...
var createBrandProfilePDF = function (clientRequest, brandProfile, campaignBrief) { return __awaiter(void 0, void 0, void 0, function () {
    var doc, mapColorsToReadable, profileConvertedColors, _a, profileColors, convertedColors, _b, colors, yOffset, durationWeeks, postsPerDay, totalDeliverables;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                mapColorsToReadable = function (colors, convertedColors) {
                    return colors.map(function (hex, index) {
                        ...
                        return convertedColor && convertedColor.name ? "".concat(hex, " (").concat(convertedColor.name, ")") : hex; // Fallback to hex if name is not available
                    });
                };
                if (!(clientRequest.primary_brand_profile && clientRequest.primary_brand_profile.length > 0)) return [3 /*break*/, 2];
            ...
            case 3:
                ...
                profileColors = clientRequest.primary_brand_profile && profileConvertedColors.length > 0
            ...
            case 6:
                convertedColors = _b;
                colors = brandProfile.colors && convertedColors.length > 0
                ...
                doc.text("- Primary Brand Colors: ".concat(profileColors.length ? profileColors.join(', ') : 'Not Available'), 10, 70);
                ...
                doc.text("    - Race/Ethnicity: ".concat(clientRequest.target_purpose.race_ethnicity), 10, 120);
                doc.text("    - Age Range: ".concat(clientRequest.target_purpose.age_range.join(', ')), 10, 130);
                doc.text("    - Interests: ".concat(clientRequest.target_purpose.interests.join(', ')), 10, 140);
                ...
                doc.text("    - Primary Ingredients: ".concat(campaignBrief.product.primary_ingredients), 10, 80);
                ...
                doc.text("    - Race/Ethnicity: ".concat(campaignBrief.target_purpose.race_ethnicity), 10, 120);
                doc.text("    - Age Range: ".concat(campaignBrief.target_purpose.age_range.join(', ')), 10, 130);
                doc.text("    - Interests: ".concat(campaignBrief.target_purpose.interests.join(', ')), 10, 140);
                ...
                doc.text("    - Duration: ".concat(campaignBrief.campaign_timing.duration || 'Not specified'), 10, 170);
                doc.text("    - Posts per day: ".concat(campaignBrief.campaign_timing.post_per_day), 10, 180);
                ...
                doc.setFont('helvetica', 'normal');
                doc.text("- ".concat(totalDeliverables, " pieces of content (images and ad copy)"), 10, 200);
...
var fetchImageDimensions = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
export var createImageThumbnailsPDF = function (weeksData, currentValues) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_c.label) {
            case 0:
                ...
                _loop_1 = function (weekIndex, week) {
                    var actualWeekNumber, yOffset, _d, week_1, day, imageWidth, imageHeight, scaledWidth, scaledHeight, gap, _e, _f, post, imageURLs, i, xOffset, j, imageURL, dataURL, _g, originalWidth, originalHeight, aspectRatio, textWidth, _data, finalText, splitText;
            ...
            case 3:
                _i++;
                return [3 /*break*/, 1];
            case 4: return [2 /*return*/, doc.output('blob')];
        }
    });
}); };
export var createWordDocument = function (weeksData, currentValues) { return __awaiter(void 0, void 0, void 0, function () {
    var sections, _i, _a, _b, weekIndex, week, actualWeekNumber, weekChildren, _c, week_2, day, _d, _e, post, doc;
            ...
            case 0:
                ...
                for (_i = 0, _a = weeksData.entries(); _i < _a.length; _i++) {
                    ...
                    for (_c = 0, week_2 = week; _c < week_2.length; _c++) {
                        ...
                        weekChildren.push(new Paragraph({
...
export var organizeAndSavePosts = function (weeksData, bigFolder, currentValues) { return __awaiter(void 0, void 0, void 0, function () {
    var _i, _a, _b, weekIndex, week, actualWeekNumber, weekFolder, _c, week_3, day, dayFolder, _d, _e, post, postFolder, dataURL, base64Data, mimeType, extension, imagesFolder, _f, _g, _h, index, image, dataURL, base64Data, mimeType, extension;
...
var convertColors = function (colors) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, fetch("".concat(url, "/api/v1/llm/convert-color"), {
