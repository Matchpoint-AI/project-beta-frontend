...
// /api/v1/fetchContent
export var fetchWebsiteData = function (url, setProgressDescription) { return __awaiter(void 0, void 0, void 0, function () {
    var llm_url, response, data, get_locations, extract_location, locations;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                llm_url = getServiceURL('llm');
                return [4 /*yield*/, fetch("".concat(llm_url, "/api/v1/llm/fetch-content"), {
                        method: 'POST',
                        headers: {
            ...
            case 2:
                ...
                return [4 /*yield*/, fetch("".concat(llm_url, "/api/v1/llm/physical-locations"), {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
