...
vi.mock('../../api/performanceApi', function () { return ({
    performanceApi: {
...
var mockLocalStorage = {
    getItem: vi.fn(function () { return 'mock_token'; }),
    setItem: vi.fn(),
    removeItem: vi.fn(),
    clear: vi.fn(),
};
...
describe('SmartInsightsPanel', function () {
    ...
    it('renders the component correctly', function () {
        mockFetch.mockResolvedValueOnce({
            ok: true,
            json: function () { return Promise.resolve(mockSummaryResponse); },
        });
    ...
    it('displays tab navigation', function () {
        ...
        render(_jsx(SmartInsightsPanel, {}));
        var summaryTabs = screen.getAllByText('Summary');
        expect(summaryTabs.length).toBeGreaterThan(0);
        expect(screen.getByText('Smart Insights')).toBeInTheDocument();
        expect(screen.getByText('Predictions')).toBeInTheDocument();
        expect(screen.getByText('Recommendations')).toBeInTheDocument();
    });
    it('fetches and displays summary data on initial load', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, waitFor(function () {
                            var overviewElements = screen.getAllByText('System Health Overview');
                            expect(overviewElements.length).toBeGreaterThan(0);
                            var scoreElements = screen.getAllByText('75');
    ...
    it('switches tabs and fetches appropriate data', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
                        ...
                        .mockResolvedValueOnce({
                        ok: true,
                        json: function () { return Promise.resolve(mockInsightsResponse); },
                    });
                    render(_jsx(SmartInsightsPanel, {}));
                ...
                case 1:
                    ...
                    return [4 /*yield*/, waitFor(function () {
                            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/api/v1/insights/smart'), expect.objectContaining({
                                headers: {
                                    Authorization: 'Bearer mock_token',
                                },
                            }));
    ...
    it('displays insights correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var highElements;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    highElements = screen.getAllByText('HIGH');
    ...
    it('displays predictions correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
                        ...
                        .mockResolvedValueOnce({
                        ok: true,
                        json: function () { return Promise.resolve(mockPredictionsResponse); },
                    });
                    render(_jsx(SmartInsightsPanel, {}));
    ...
    it('displays recommendations correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var stepsElements;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
                        ...
                        .mockResolvedValueOnce({
                        ok: true,
                        json: function () { return Promise.resolve(mockRecommendationsResponse); },
                    });
                    render(_jsx(SmartInsightsPanel, {}));
                ...
                case 1:
                    _a.sent();
                    stepsElements = screen.getAllByText('Implementation Steps:');
    ...
    it('allows filtering insights', function () { return __awaiter(void 0, void 0, void 0, function () {
        var typeSelect;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
                        ...
                        .mockResolvedValueOnce({
                        ok: true,
                        json: function () { return Promise.resolve([mockInsightsResponse[0]]); }, // Filtered response
                    });
                    render(_jsx(SmartInsightsPanel, {}));
                    // Switch to insights tab
                    fireEvent.click(screen.getByText('Smart Insights'));
                ...
                case 1:
                    ...
                    return [4 /*yield*/, waitFor(function () {
                            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('insight_types=cost_optimization'), expect.any(Object));
                        })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('submits feedback for insights', function () { return __awaiter(void 0, void 0, void 0, function () {
        var helpfulButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, waitFor(function () {
                            expect(mockFetch).toHaveBeenCalledWith('/api/v1/insights/feedback?insight_id=insight_1&feedback_type=helpful', expect.objectContaining({
                                method: 'POST',
                                headers: {
                                    Authorization: 'Bearer mock_token',
                                },
    ...
    it('handles loading states', function () {
        ...
        mockFetch.mockImplementation(function () { return new Promise(function () { }); });
        render(_jsx(SmartInsightsPanel, {}));
        expect(screen.getByText('Loading summary...')).toBeInTheDocument();
    });
    it('handles empty data states', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
                        ...
                        .mockResolvedValueOnce({
                        ok: true,
                        json: function () { return Promise.resolve([]); }, // Empty insights
                    });
                    render(_jsx(SmartInsightsPanel, {}));
                    // Switch to insights tab
                    fireEvent.click(screen.getByText('Smart Insights'));
    ...
    it('displays severity and confidence badges correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
    ...
    it('shows automated actions when available', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
    ...
    it('shows risk information in recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch
