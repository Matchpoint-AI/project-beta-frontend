...
export var PerformanceDashboard = function () {
  ...
  var _g = useState(''),
    _selectedMetricType = _g[0],
    _setSelectedMetricType = _g[1];
  // State for data
  var _h = useState({}),
    metricsSummaries = _h[0],
    setMetricsSummaries = _h[1];
  var _j = useState([]),
    alerts = _j[0],
    setAlerts = _j[1];
  var _k = useState(null),
    costAnalysis = _k[0],
    setCostAnalysis = _k[1];
  var _l = useState(null),
    healthStatus = _l[0],
    setHealthStatus = _l[1];
  // Loading states
  var _m = useState({
      metrics: false,
      alerts: false,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            metricsPromises = METRIC_TYPES.map(function (metricType) {
              return __awaiter(void 0, void 0, void 0, function () {
                var summary;
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      return [
                        4 /*yield*/,
                        performanceApi.getMetricsSummary({
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_2 = _a.sent();
            console.error('Failed to resolve alert:', error_2);
            return [3 /*break*/, 4];
          case 4:
            return [2 /*return*/];
        }
    ...
    datasets: [
      {
        ...
        data: [
          ((_a = metricsSummaries.latency) === null || _a === void 0 ? void 0 : _a.median_value) ||
            0,
  ...
  var costByOperationData = (
    costAnalysis === null || costAnalysis === void 0 ? void 0 : costAnalysis.cost_by_operation
  )
    ? {
    ...
    : null;
  var costByModelData = (
    costAnalysis === null || costAnalysis === void 0 ? void 0 : costAnalysis.cost_by_model
  )
    ? {
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx('select', {
                ...
                children: TIME_RANGES.map(function (_a) {
                  var label = _a.label,
                    hours = _a.hours;
          ...
          children: [
                ...
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs('h3', {
                      ...
                      children: ['System Health: ', healthStatus.status],
                    }),
                  ],
                }),
                _jsxs('div', {
                  className: 'text-sm text-gray-600',
                  children: ['Last check: ', new Date(healthStatus.last_check).toLocaleString()],
                }),
              ],
            }),
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', { children: ['Recent Metrics: ', healthStatus.recent_metrics_count] }),
                _jsxs('div', { children: ['Active Alerts: ', healthStatus.active_alerts_count] }),
            ...
            healthStatus.error &&
              _jsxs('div', {
                ...
                children: ['Error: ', healthStatus.error],
              }),
          ],
        }),
      _jsx('div', {
        className: 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6',
        children: METRIC_TYPES.map(function (metricType) {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('h3', {
                      ...
                      children: metricType.replace('_', ' '),
                    }),
                    _jsx(TrendIcon, { trend: summary.trend }),
                  ],
                }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsx('span', { className: 'font-medium', children: summary.count }),
                      ],
                    }),
                    summary.mean_value !== null &&
                      _jsxs('div', {
                        className: 'flex justify-between',
                        children: [
                          _jsx('span', { children: 'Average:' }),
                          _jsx('span', {
                            className: 'font-medium',
                            children: summary.mean_value.toFixed(3),
                          }),
                        ],
                      }),
                    summary.p95_value !== null &&
                      _jsxs('div', {
                        className: 'flex justify-between',
                        children: [
                          _jsx('span', { children: 'P95:' }),
                          _jsx('span', {
                            className: 'font-medium',
                            children: summary.p95_value.toFixed(3),
                          }),
                        ],
                      }),
                    summary.max_value !== null &&
                      _jsxs('div', {
                        className: 'flex justify-between',
                        children: [
                          _jsx('span', { children: 'Max:' }),
                          _jsx('span', {
                            className: 'font-medium',
                            children: summary.max_value.toFixed(3),
                          }),
                        ],
                      }),
                  ],
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              ((_e = metricsSummaries.latency) === null || _e === void 0 ? void 0 : _e.count) > 0
                ? _jsx(Bar, {
                    data: latencyData,
                    options: {
                      responsive: true,
        ...
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx('h3', { className: 'text-lg font-semibold', children: 'Cost Analysis' }),
                _jsx(TrendIcon, { trend: costAnalysis.trend }),
              ],
            }),
            _jsxs('div', {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: ['$', costAnalysis.total_cost.toFixed(2)],
                    }),
                    _jsx('div', { className: 'text-sm text-gray-600', children: 'Total Cost' }),
                  ],
                }),
                _jsxs('div', {
                  className: 'text-center',
                  children: [
                    _jsx('div', {
                      ...
                      children: costAnalysis.total_tokens.toLocaleString(),
                    }),
                    _jsx('div', { className: 'text-sm text-gray-600', children: 'Total Tokens' }),
                  ],
                }),
                _jsxs('div', {
                  className: 'text-center',
                  children: [
                    _jsxs('div', {
                      ...
                      children: ['$', (costAnalysis.cost_per_1k_tokens * 1000).toFixed(3)],
                    }),
                    _jsx('div', {
                      className: 'text-sm text-gray-600',
                      children: 'Cost per 1K Tokens',
                    }),
                  ],
                }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: ['$', costAnalysis.summary_stats.mean.toFixed(3)],
                    }),
                    _jsx('div', {
                      className: 'text-sm text-gray-600',
                      children: 'Avg per Operation',
                    }),
                  ],
                }),
              ],
            ...
            costByModelData &&
              _jsxs('div', {
                className: 'mt-6',
                children: [
                  _jsx('h4', { className: 'text-md font-medium mb-3', children: 'Cost by Model' }),
                  _jsx('div', {
                    className: 'h-64',
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsxs('div', {
              className: 'flex justify-between items-center',
              children: [
                _jsx('h3', { className: 'text-lg font-semibold', children: 'Active Alerts' }),
                _jsxs('span', {
                  className: 'text-sm text-gray-600',
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              _jsxs('div', {
                                ...
                                children: [
                                  _jsx(AlertTriangle, { className: 'h-5 w-5 text-orange-500' }),
                                  _jsxs('div', {
                                    children: [
                                      _jsx('div', {
                                        className: 'font-medium',
                              ...
                              _jsxs('div', {
                                className: 'flex items-center gap-3',
                                children: [
                                  _jsx(AlertBadge, { severity: alert.severity }),
                                  _jsx('button', {
                                    onClick: function () {
                                      return resolveAlert(alert.id);
                                    },
                                    className:
                                      'px-3 py-1 text-sm bg-gray-100 hover:bg-gray-200 rounded',
                                    children: 'Resolve',
                                  }),
                                ],
                              }),
