...
const Features = () => {
   const cards = [
      ...
      },
      {
         ...
         description:
            "Track performance and tweak strategies for better results.",
         bgColor: "bg-blue-400",
      },
      {
      ...
      },
      {
         ...
         description:
            "Leverage AI insights to optimize strategies and boost performance.",
         bgColor: "bg-yellow-400",
      },
      {
         title: "Seamless Collaboration",
         description:
            "Work together with your team effortlessly for efficient content creation.",
         bgColor: "bg-orange-400",
      },
      {
         title: "Automated Workflows",
         description:
            "Save time with smart automation for repetitive tasks and content delivery.",
         bgColor: "bg-cyan-400",
      },
      {
         title: "Social Engagement",
         description:
            "Boost audience interaction with tailored posts and data-driven campaigns.",
         bgColor: "bg-red-400",
      },
      {
         title: "Unified Dashboard",
         description:
            "Manage all your social platforms in one intuitive interface.",
         bgColor: "bg-indigo-400",
      },
      {
         title: "Advanced Security",
         description:
            "Ensure data privacy with top-tier protection and encrypted systems.",
         bgColor: "bg-gray-400",
      },
      {
         title: "Multi-Channel Posting",
         description:
            "Expand your reach with scheduled posts across multiple platforms.",
         bgColor: "bg-lime-400",
      },
      {
         title: "Performance Tracking",
         description:
            "Monitor real-time stats and optimize content for better results.",
         bgColor: "bg-amber-400",
      },
      {
         title: "Personalized Campaigns",
         description:
            "Create tailored campaigns that resonate with your audience effectively.",
                  ...
                  <div
                     ...
                     {cards.map((card, index) => (
                        <div
                           ...
                           <div
                              className={`${card.bgColor} w-[30px] h-[30px] lg:w-[40px] lg:h-[40px] rounded-full`}></div>
                           <div className="flex flex-col gap-5">
                              <h3 className="text-xl lg:text-3xl font-medium text-[#221F28]">
                                 {card.title}
                              </h3>
                              <p className="text-black font-normal text-sm lg:text-xl">
                                 {card.description}
                              </p>
                           </div>
                        </div>
