...
var Features = function () {
  ...
  return _jsx('div', {
    id: 'features',
    className:
      'flex flex-col w-full lg:flex-row items-center justify-start gap-8 px-5 py-20 lg:px-16 lg:py-28 bg-gradient-to-tr from-white/40  to-[#8DA6FF]/40',
    children: _jsxs('div', {
      className: 'relative w-full flex flex-col lg:flex-row justify-start items-start gap-7 ',
      children: [
        _jsx('img', {
        ...
        _jsxs('div', {
          className: 'flex w-full flex-col justify-strat items-start lg:mt-6 gap-9',
          children: [
            _jsxs('div', {
              className: 'w-full pl-2 lg:pl-0',
              children: [
                _jsx('h2', {
                  className: 'text-4xl lg:text-5xl lg:leading-[60px] text-[#30175A] font-medium',
                  children: 'Features',
                }),
                _jsx('p', {
                  className: 'text-2xl lg:text-4xl text-[#6D607E] font-normal',
                  children: 'Unique features and offerings',
                }),
              ],
            }),
            _jsx('div', {
              className:
                'rounded-lg lg:absolute w-full lg:w-[80%] xl:w-[85%] 2xl:w-[88%] overflow-hidden lg:left-52  lg:bottom-1/4 flex flex-col lg:flex-row',
              children: _jsx('div', {
                ...
                style: __assign(
                  {
                    transform:
                      window.innerWidth >= 1024
                        ...
                        : 'translateX(-'.concat(currentIndex * 238, 'px)'),
                  },
                  window.innerWidth >= 1024 && {
                ...
                children: cards.map(function (card, index) {
                  return _jsxs(
                    ...
                    {
                      className:
                        'w-[230px] h-[250px] lg:w-[300px] lg:h-[300px] p-8 bg-white rounded-lg shadow-lg flex flex-col items-center justify-between text-center flex-shrink-0',
                      children: [
                        _jsx('div', {
                          className: ''.concat(
                            card.bgColor,
                            ' w-[30px] h-[30px] lg:w-[40px] lg:h-[40px] rounded-full'
                          ),
                        }),
                        _jsxs('div', {
                          ...
                          children: [
                            _jsx('h3', {
                              className: 'text-xl lg:text-3xl font-medium text-[#221F28]',
                              children: card.title,
                            }),
                            _jsx('p', {
                              className: 'text-black font-normal text-sm lg:text-xl',
        ...
        _jsxs('div', {
          className: 'flex self-end justify-self-start place-self-end gap-4',
          children: [
            _jsx(IoIosArrowBack, {
              onClick: handlePrev,
