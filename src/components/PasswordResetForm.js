...
export default function PasswordResetForm(_a) {
  ...
  var _b = useState(''),
    ...
    setPassword = _b[1];
  var _c = useState(''),
    confirmPassword = _c[0],
    setConfirmPassword = _c[1];
    ...
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (mode === 'resetPassword') {
          ...
          if (!code_1) return [2 /*return*/, navigate('/reset-password')];
      ...
      children: [
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            error &&
              _jsx('p', {
                className: 'text-[#F05252] font-medium text-sm mt-1',
                children: 'Passwords do not match',
              }),
          ],
        }),
        _jsx('button', {
          className: 'px-3 py-2 text-white bg-[#5145CD] hover:bg-[#6875F5] font-medium rounded-lg',
          children: reseting
