...
vi.mock('../features/dashboard/components/CardStats', function () { return ({
    default: function (_a) {
        var id = _a.id;
        return _jsxs("div", { "data-testid": "card-stats", children: ["Stats for ", id] });
    },
}); });
vi.mock('./dashboard/CampaignReviewButton', function () { return ({
    default: function (_a) {
        var _campaign = _a.campaign;
        return (_jsx("button", { "data-testid": "review-button", children: "Review Campaign" }));
    },
}); });
vi.mock('./campaign/CampaignThreadWin', function () { return ({
    default: function (_a) {
        var open = _a.open, _onClose = _a.onClose;
        return open ? _jsx("div", { "data-testid": "thread-win", children: "Thread Window" }) : null;
    },
}); });
vi.mock('../hooks/useFetchThreadMessages', function () { return ({
...
vi.mock('react-router-dom', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                actual = _a.sent();
                return [2 /*return*/, __assign(__assign({}, actual), { useNavigate: function () { return mockNavigate; }, Link: function (_a) {
                            var to = _a.to, children = _a.children, props = __rest(_a, ["to", "children"]);
                            return (_jsx("a", __assign({ href: to, "data-testid": "campaign-link" }, props, { children: children })));
                        } })];
        }
    });
}); });
...
var renderWithContext = function (campaign, status, authValue, campaignValue) {
    if (campaign === void 0) { campaign = mockCampaign; }
    if (status === void 0) { status = 'Current'; }
    if (authValue === void 0) { authValue = mockAuthContextValue; }
    if (campaignValue === void 0) { campaignValue = mockCampaignContextValue; }
    return render(_jsx(BrowserRouter, { children: _jsx(AuthContext.Provider, { value: authValue, children: _jsx(CampaignContext.Provider, { value: campaignValue, children: _jsx(PromotionComponent, { campaign: campaign, status: status }) }) }) }));
};
describe('PromotionComponent', function () {
    ...
    it('should render clickable title for draft campaigns that calls handleDraft', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            draftCampaignContext = __assign(__assign({}, mockCampaignContextValue), { setCampaignInfo: mockSetCampaignInfo });
    ...
    it('should navigate to content library when Content Library button is clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(handleNavigate).toHaveBeenCalledWith('test-user-id', '/campaign/content/test-campaign-1', expect.any(Function));
                    return [2 /*return*/];
            }
        });
    }); });
