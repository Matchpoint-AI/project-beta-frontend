...
var TimingForm = function (_a) {
  ...
  var _h = useState(
      (_b = campaignInfo === null || campaignInfo === void 0 ? void 0 : campaignInfo.duration) !==
        null && _b !== void 0
        ? _b
        : '1 Week'
    ),
  ...
  var _j = useState(
      (_c =
        campaignInfo === null || campaignInfo === void 0
          ? void 0
          : campaignInfo.postingFrequency) !== null && _c !== void 0
        ? _c
        : '3 posts per day'
    ),
    postingFrequency = _j[0],
    setPostingFrequency = _j[1];
  var _k = useState(
      (_d =
  ...
  useEffect(
    function () {
      ...
      setCampaignInfo(function (prev) {
        return __assign(__assign({}, prev), { startDate: date });
      });
      if (setTiming) {
  ...
  useEffect(
    function () {
      ...
      setCampaignInfo(function (prev) {
        return __assign(__assign({}, prev), { duration: duration, durationNum: durationNum });
      });
      if (setTiming) {
        var date = value === null || value === void 0 ? void 0 : value.format('MM/DD/YYYY');
        if (date === undefined) return;
  ...
  useEffect(
    function () {
      setCampaignInfo(function (prev) {
        return __assign(__assign({}, prev), { deliveryDay: deliveryDay });
      });
    },
    [deliveryDay]
  );
          ...
          children: [
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('div', {
                  className: 'flex items-center gap-4 bg-[#EBF5FF] py-1 px-1 rounded-md my-2',
                  children: [
                    _jsx('img', { src: '/sparkles.svg', alt: 'location', className: 'w-5 h-5' }),
                    _jsx('p', {
                      className: 'text-sm text-[#1C64F2]',
                      children: 'Recommendation: min 3 weeks',
                    }),
                  ],
                }),
              ],
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('label', {
                  title: 'email',
                  className: 'block mb-2 text-xl font-medium text-gray-900',
                  children: 'Date Posting Frequency',
                }),
                _jsx(Dropdown, {
                  ...
                  onUpdateContext: function (value) {
                    return setPostingFrequency(value);
                  },
                  className: 'w-full',
                }),
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('p', {
                      className: 'text-sm text-[#1C64F2]',
                      children: 'Recommendation: min 3 posts per day',
                    }),
                  ],
                }),
              ],
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('label', {
                  title: 'email',
                  className: 'block mb-2 text-xl font-medium text-gray-900',
                  children: 'Content Delivery Day',
                }),
                _jsx('p', {
                  className: 'my-2 text-sm text-[#111928]',
                  children: 'We deliver content in weekly batches',
                }),
                _jsx(Dropdown, {
      ...
      !review &&
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx(NextButton, { text: 'Next', formId: 'timing_form' }),
          ],
        }),
    ],
  });
