...
var AudienceForm = function (_a) {
  ...
  var handleNext = _a.handleNext,
    ...
    _g = _a.review,
    review = _g === void 0 ? false : _g;
  var businessInfo = useContext(BrandContext).businessInfo;
  var _h = useContext(CampaignContext),
    campaignInfo = _h.campaignInfo,
    setCampaignInfo = _h.setCampaignInfo;
  var profile = useAuth().profile;
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  var _j = React.useState((_b = campaignInfo.audienceEmotion) !== null && _b !== void 0 ? _b : []),
    audienceEmotion = _j[0],
    setAudienceEmotion = _j[1];
  var _k = React.useState(
      (_c = campaignInfo.audienceInterests) !== null && _c !== void 0 ? _c : []
    ),
    audienceInterests = _k[0],
    setAudienceInterests = _k[1];
  var options = ['All Ages', '18-24', '25-34', '35-44', '45-54', '55-64', '18+', '21+', '65+'];
  var _l = useState((_d = campaignInfo.audienceAgeRange) !== null && _d !== void 0 ? _d : []),
    audienceAgeRange = _l[0],
    setAudienceAgeRage = _l[1];
  var _m = useState((_e = campaignInfo.audienceGender) !== null && _e !== void 0 ? _e : ''),
    audienceGender = _m[0],
    setAudienceGender = _m[1];
  var _o = useState((_f = campaignInfo.audienceRace) !== null && _f !== void 0 ? _f : ''),
    audienceRace = _o[0],
    setAudienceRace = _o[1];
  // audienceRace
  var prompt = 'For the brand '
    .concat(businessInfo.name, ' and the data we collected from their URL in step 1: ')
    .concat(
      JSON.stringify({
    ...
    .concat(businessInfo.industry, ' industry and ')
    .concat(
        ...
        if (arrays && arrays.length === 2) {
          ...
          setCampaignInfo(function (prev) {
            return __assign(__assign({}, prev), {
              audienceEmotion: array1_1.slice(0, 3),
              audienceInterests: array2_1.slice(0, 3),
            });
          });
  ...
  useEffect(
    function () {
      setCampaignInfo(function (prev) {
        return __assign(__assign({}, prev), { audienceAgeRange: audienceAgeRange });
      });
    },
    [audienceAgeRange]
  );
  useEffect(
    function () {
      setCampaignInfo(function (prev) {
        return __assign(__assign({}, prev), { audienceGender: audienceGender });
      });
    },
    [audienceGender]
  );
  useEffect(
    function () {
      setCampaignInfo(function (prev) {
        return __assign(__assign({}, prev), { audienceRace: audienceRace });
      });
    },
    [audienceRace]
  );
    ...
    children: [
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('label', {
                  ...
                  children: 'Audience Gender',
                }),
                _jsx('p', { className: 'my-2 text-sm text-[#111928]', children: 'Select 1' }),
                _jsx(Dropdown, {
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('label', {
                  title: 'email',
                  className: 'block mb-2 text-xl font-medium text-gray-900',
                  children: 'Audience Race/Ethnicity',
                }),
                _jsx('p', { className: 'my-2 text-sm text-[#111928]', children: 'Select 1' }),
                _jsx(Dropdown, {
              ...
              children: [
                _jsx('div', {
                  ...
                  children: _jsx('label', {
                    title: 'email',
                    className: 'block mb-2 text-xl font-medium text-gray-900',
                    children: 'Audience Age Range',
                  }),
                }),
                _jsx('p', { className: 'text-[#111928] text-sm', children: 'Select up to 2' }),
                _jsx('div', {
                  className: 'mt-2 space-x-0 space-y-2 p-0 rounded-md',
                  children: _jsx(AgeDropdown, {
      ...
      !review &&
        _jsxs('div', {
          ...
          children: [
            _jsx(BackButton, { onClick: clickHandler }),
