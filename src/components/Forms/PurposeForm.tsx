...
const PurposeForm = ({ handleNext, review = false }: PurposeFormProps) => {
   ...
   const [purpose, setPurpose] = useState(
      campaignInfo?.purpose ?? "Make customers aware/excited"
   );
   ...
   useEffect(() => {
      ...
      if (campaignInfo?.purposeAbout)
         setPurposeAbout(campaignInfo?.purposeAbout);
   }, [campaignInfo]);
            ...
            <form id="purpose_form" onSubmit={handleSubmit}>
               ...
               <div className="mb-5">
                  ...
                  <p className="my-2 text-sm text-[#111928]">
                     What do you want customers to know or do after seeing your
                     campaign?
                  </p>
                  <Dropdown
                     open={openPurpose}
