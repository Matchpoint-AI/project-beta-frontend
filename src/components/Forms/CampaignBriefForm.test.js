...
vi.mock('../../shared/components/buttons/ApproveButton', function () {
  return {
    default: function (_a) {
      var onClick = _a.onClick;
      return _jsx('button', {
...
vi.mock('../campaign/CampaignSetupCompleteDialog', function () {
  return {
    default: function (_a) {
      var open = _a.open,
        onClose = _a.onClose,
        _setCurrentStep = _a.setCurrentStep;
      return open
        ? _jsx('div', {
            'data-testid': 'campaign-setup-complete-dialog',
            onClick: onClose,
...
vi.mock('../campaign/CustomDialog', function () {
  return {
    default: function (_a) {
...
vi.mock('../CampaignBriefTimingBlock', function () {
  return {
    default: function (_a) {
      var title = _a.title,
        children = _a.children;
      return _jsxs('div', {
        'data-testid': 'timing-block',
        children: [_jsx('h3', { children: title }), children],
      });
    },
  };
});
vi.mock('../campaign/CampaignDetailsBlock', function () {
  return {
    default: function (_a) {
      var title = _a.title,
        text = _a.text;
      return _jsxs('div', {
        'data-testid': 'campaign-details-block',
        children: [_jsx('h4', { children: title }), _jsx('p', { children: text })],
      });
    },
  };
});
vi.mock('../campaign/CampaignDetails', function () {
  return {
    default: function () {
      return _jsx('div', { 'data-testid': 'campaign-details' });
    },
  };
});
vi.mock('../CampaignSchedule', function () {
  return {
    default: function () {
      return _jsx('div', { 'data-testid': 'campaign-schedule' });
    },
  };
});
// Mock dayjs
...
vi.mock('../../helpers/getServiceURL', function () {
  return {
    getServiceURL: function (service) {
      return 'https://mock-'.concat(service, '-service.com');
    },
  };
});
  ...
  var renderWithProviders = function (component) {
    return render(
      _jsx(BrandContext.Provider, {
        value: { businessInfo: mockBusinessInfo, setBusinessInfo: vi.fn() },
