...
export default function AudienceDetails(props: AudienceEmotionsProps) {
   ...
   return (
      <div className="mb-5">
         ...
         {props.description && (
            <p className="text-[#6B7280] text-sm mb-3">{props.description}</p>
         )}
         <SparklesMessage>
            Matchpoint tailored these suggestions to your brand. They inform the
            scenes and activities shown in your content—feel free to edit/add
            more up to 3 total
         </SparklesMessage>
         {!edit && (
            <div
