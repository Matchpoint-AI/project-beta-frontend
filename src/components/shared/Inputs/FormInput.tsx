  ...
  return (
    <div className="mb-5">
      ...
      >
        {subject === "name"
          ? "What are you called?"
          : "Add you business website"}
      </label>
      {subject === "website" && (
        <p className="text-[14px] mb-1">
          Import information on your brand, products and audience from your
          website
        </p>
      )}
      <div
        ...
        style={{
          borderColor: `${
            !error ? "#d1d5db" : error.error ? "#F05252" : "#0E9F6E"
          }`,
        }}
      >
        {subject === "website" && (
          ...
          >
            <path
              ...
              stroke={`${
                !error ? "#6B7280" : error.error ? "#6c0404" : "#046C4E"
              }`}
              strokeWidth="2"
        ...
        <input
          ...
          style={{
            color: `${
              !error ? "#111827" : error.error ? "#6c0404" : "#046C4E"
            }`,
          }}
        />
