...
export default function PhoneNavIcons({ currentStep }: { currentStep: number }) {
  return (
    <div className="flex justify-between items-center gap-2">
      <img
        src={currentStep >= 1 ? `briefcase_active.svg` : `briefcase_gray.svg`}
        alt="briefcase"
        width={25}
        height={25}
      />
      ...
      />
      <img
        src={currentStep >= 3 ? `clipboard_active.svg` : `clipboard_gray.svg`}
        alt="clipboard"
        width={25}
        height={25}
      />
