...
var VersionDisplay = function (_a) {
    ...
    var shouldShowVersion = mode === 'development' ||
        mode === 'staging' ||
        nodeEnv === 'development' ||
        appEnv === 'dev' ||
        appEnv === 'staging' ||
    ...
    return (_jsx("div", { className: "fixed bottom-2 right-2 bg-black bg-opacity-70 text-white text-xs px-2 py-1 rounded z-50 font-mono ".concat(className), "data-testid": "version-display", children: displayVersion }));
};
