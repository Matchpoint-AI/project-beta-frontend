...
export default function SettingsLayout() {
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsxs('main', {
        className:
          'flex flex-col px-8 pt-28 md:pt-12 md:pl-28 bg-gradient-to-b min-h-screen from-[#F1FDFF] to-[#F5D9FF] ',
        children: [
          _jsx('h1', { className: 'text-3xl font-bold mb-6', children: 'Settings' }),
          _jsx('header', {
            className: 'pl-4 ',
            children: _jsx('nav', {
