...
export var CostOptimizationDashboard = function () {
  ...
  var _e = useState(null),
    _selectedOptimization = _e[0],
    setSelectedOptimization = _e[1];
  useEffect(
    function () {
      fetchDashboardData();
    },
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            err_1 = _a.sent();
            setError(err_1 instanceof Error ? err_1.message : 'Failed to load cost dashboard data');
            return [3 /*break*/, 4];
          case 3:
            setLoading(false);
            return [7 /*endfinally*/];
  ...
  var createSavingsTrendChart = function () {
    if (
      !(dashboardData === null || dashboardData === void 0 ? void 0 : dashboardData.daily_savings)
    )
      return null;
    var data = {
      labels: dashboardData.daily_savings.map(function (d) {
        return new Date(d.date).toLocaleDateString();
      }),
      datasets: [
        {
          label: 'Daily Savings',
          data: dashboardData.daily_savings.map(function (d) {
            return d.daily_savings;
          }),
          borderColor: '#10B981',
  ...
  var createOptimizationComparisonChart = function () {
    if (
      !(dashboardData === null || dashboardData === void 0
        ? void 0
        : dashboardData.optimization_metrics)
    )
      return null;
    var metrics = dashboardData.optimization_metrics.filter(function (m) {
      return OPTIMIZATION_CONFIG[m.optimization_type];
    });
    var data = {
      labels: metrics.map(function (m) {
        var _a;
        return (
          ((_a = OPTIMIZATION_CONFIG[m.optimization_type]) === null || _a === void 0
            ? void 0
            : _a.name) || m.optimization_type
        );
      }),
      datasets: [
        {
          ...
          data: metrics.map(function (m) {
            return m.projected_annual_savings;
          }),
  ...
  var createModelDistributionChart = function () {
    if (
      !(dashboardData === null || dashboardData === void 0
        ? void 0
        : dashboardData.current_model_distribution)
    )
      return null;
    ...
    var data = {
      labels: models.map(function (_a) {
        var model = _a[0];
        return model.replace(/-/g, ' ').replace(/\b\w/g, function (l) {
  ...
  if (loading) {
    return _jsx('div', {
      ...
      children: _jsx(LoadingSpinner, { size: 'lg' }),
    });
  }
  if (error) {
    return _jsxs(Card, {
      ...
      children: [
        _jsxs('div', {
          ...
          children: [
            ...
            _jsxs('span', { children: ['Error loading cost dashboard: ', error] }),
          ],
        }),
        _jsx(Button, { onClick: fetchDashboardData, className: 'mt-4', children: 'Retry' }),
      ],
    });
  }
  if (!dashboardData) {
  ...
  return _jsxs('div', {
    ...
    children: [
          ...
          _jsxs('div', {
            children: [
              _jsx('h1', {
                ...
                children: 'Cost Optimization Dashboard',
              }),
              _jsx('p', {
                className: 'text-gray-600 mt-1',
                children: 'Track the 90% cost reduction achievement through AI model optimizations',
              }),
            ],
          }),
          _jsxs('div', {
            ...
            children: [
              _jsx('select', {
                ...
                onChange: function (e) {
                  return setSelectedTimeRange(Number(e.target.value));
                },
                className:
                  'rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500',
                children: TIME_RANGES.map(function (range) {
                  return _jsx('option', { value: range.days, children: range.label }, range.days);
                }),
              }),
              _jsx(Button, {
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  ...
                  children: _jsx(DollarSign, { className: 'h-6 w-6 text-green-600' }),
                }),
                _jsxs('div', {
                  className: 'ml-4',
                  children: [
                    ...
                    _jsx('p', {
                      ...
                      children: formatCurrency(dashboardData.total_absolute_savings),
                    }),
                    _jsxs('p', {
                      className: 'text-sm text-green-600',
                      children: [
                        formatPercentage(dashboardData.total_percentage_savings),
                        ' reduction',
                      ],
                    }),
                  ],
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  ...
                  children: _jsx(TrendingUp, { className: 'h-6 w-6 text-blue-600' }),
                }),
                _jsxs('div', {
                  className: 'ml-4',
                  children: [
                    ...
                    _jsx('p', {
                      className: 'text-2xl font-bold text-gray-900',
                      children: formatCurrency(dashboardData.projected_annual_savings),
                    }),
                    _jsx('p', {
                      className: 'text-sm text-blue-600',
                      children: 'Based on current trend',
                    }),
                  ],
                }),
              ],
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  ...
                  children: _jsx(Award, { className: 'h-6 w-6 text-purple-600' }),
                }),
                _jsxs('div', {
                  className: 'ml-4',
                  children: [
            ...
            children: _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  ...
                  children: _jsx(Target, { className: 'h-6 w-6 text-amber-600' }),
                }),
                _jsxs('div', {
                  className: 'ml-4',
                  children: [
                    ...
                    _jsx('p', {
                      className: 'text-2xl font-bold text-gray-900',
                      children: formatPercentage(dashboardData.budget_utilization * 100),
                    }),
                    _jsx('div', {
                      className: 'w-full bg-gray-200 rounded-full h-2 mt-1',
                      children: _jsx('div', {
                        className: 'bg-amber-600 h-2 rounded-full',
                        style: { width: ''.concat(dashboardData.budget_utilization * 100, '%') },
                      }),
                    }),
                  ],
                }),
      ...
      _jsx('div', {
        ...
        children: dashboardData.optimization_metrics.map(function (metric) {
          ...
          return _jsxs(
            Card,
            {
              ...
              onClick: function () {
                return setSelectedOptimization(metric.optimization_type);
              },
              children: [
                _jsxs('div', {
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('div', {
                          ...
                          style: { backgroundColor: ''.concat(config.color, '20') },
                          children: getOptimizationIcon(metric.optimization_type),
                        }),
                        _jsxs('div', {
                          children: [
                            _jsx('h3', {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('span', { className: 'text-sm text-gray-600', children: 'Savings:' }),
                        _jsx('span', {
                          className: 'font-semibold '.concat(
                            getSavingsColor(metric.percentage_savings)
                          ),
                          children: formatPercentage(metric.percentage_savings),
                        }),
                      ],
                    }),
                    _jsxs('div', {
                      className: 'flex justify-between items-center',
                      children: [
                        _jsx('span', { className: 'text-sm text-gray-600', children: 'Annual:' }),
                        _jsx('span', {
                          className: 'font-semibold text-gray-900',
                          children: formatCurrency(metric.projected_annual_savings),
                        }),
                      ],
                    }),
                      ...
                      children: _jsx('div', {
                        ...
                        style: {
                          width: ''.concat(
                            Math.min(
                              100,
                              (metric.percentage_savings / config.expectedSavings) * 100
                            ),
                            '%'
                          ),
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx(Card, {
            className: 'p-6',
            children: _jsx('div', { className: 'h-80', children: createSavingsTrendChart() }),
          }),
          _jsx(Card, {
            className: 'p-6',
            children: _jsx('div', {
              className: 'h-80',
              children: createOptimizationComparisonChart(),
            }),
          }),
          _jsx(Card, {
            className: 'p-6',
            children: _jsx('div', {
              ...
              children: createModelDistributionChart(),
            }),
          }),
          _jsx(Card, {
            className: 'p-6',
                  ...
                  datasets: [
                    {
                      ...
                      data: dashboardData.cost_efficiency_trend.map(function (d) {
                        return d.cost_efficiency * 100;
                      }),
                      borderColor: '#8B5CF6',
        ...
        _jsxs(Card, {
          ...
          children: [
            _jsx('h2', {
              ...
              children: 'Cost Alerts',
            }),
            _jsx('div', {
              className: 'space-y-3',
              children: dashboardData.cost_alerts.map(function (alert, index) {
                var _a;
                return _jsx(
                  'div',
                  {
                    className: 'p-4 rounded-lg border-l-4 '.concat(
                        ...
                        _jsxs('div', {
                          ...
                          children: [
                            _jsx('h3', {
                              ...
                              children:
                                ((_a = OPTIMIZATION_CONFIG[alert.optimization]) === null ||
                                _a === void 0
                                  ? void 0
                                  : _a.name) || alert.optimization,
                            }),
                            _jsx('p', {
      ...
      _jsxs(Card, {
        ...
        children: [
          _jsx('h2', {
            className: 'text-xl font-semibold text-gray-900 mb-4',
            children: 'Top Savings Opportunities',
          }),
          _jsx('div', {
            className: 'space-y-3',
            children: dashboardData.top_savings_by_optimization
              .slice(0, 5)
                    ...
                    children: [
                          ...
                          _jsx('div', {
                            ...
                            style: {
                              backgroundColor: ''.concat(
                                (config === null || config === void 0 ? void 0 : config.color) ||
                                  '#6B7280',
                                '20'
                              ),
                            },
                            children: getOptimizationIcon(opportunity.optimization_type),
                          }),
                          _jsxs('div', {
                            children: [
                              _jsx('h3', {
                              ...
                              _jsxs('p', {
                                className: 'text-sm text-gray-600',
                                children: [
                                  formatPercentage(opportunity.percentage_savings),
                                  ' savings',
                                ],
                              }),
                            ],
                      ...
                      _jsxs('div', {
                        ...
                        children: [
                          _jsx('p', {
                            className: 'font-semibold text-gray-900',
                            children: formatCurrency(opportunity.annual_savings),
                          }),
                          _jsx('p', {
                            className: 'text-sm text-gray-600',
                            children: 'Annual potential',
                          }),
                        ],
                      }),
                    ],
