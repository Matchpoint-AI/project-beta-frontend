    ...
    return __awaiter(_this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        setBusinessInfo(function (prev) {
          return __assign(__assign({}, prev), { checkZip: !checkZip });
        });
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(SparklesMessage, {
        children: "We've not detected any physical locations for your business.",
      }),
      checkZip === true &&
        _jsx('div', {
          className: 'my-10',
          children: _jsx(ZipCodeInput, {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('label', {
            ...
            children: 'Add physical locations by zip code',
          }),
        ],
      }),
    ],
...
export function PhysicalLocationsFound(props) {
  ...
  return _jsx(_Fragment, {
    children: _jsxs('div', {
      ...
      children: [
        _jsx(SparklesMessage, {
          children: 'We\u2019ve detected your brand has physical locations in these areas.',
        }),
        _jsx('p', {
          className: 'text-sm text-[#6B7280]',
          children:
            'You may remove locations as you wish. To add a location please type the zip code of the city it\u2019s in.',
        }),
        !checkZip &&
          _jsx(ZipCodeInput, {
            currentValues: props.physicalLocations,
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx('label', {
              ...
              title: 'location',
              className: 'ms-2 text-sm font-medium text-[#111928]',
              children: 'My brand does not have physical locations.',
            }),
          ],
        }),
      ],
...
export function PhysicalLocations(props) {
  return _jsxs('div', {
    ...
    children: [
      _jsx('h2', {
        className: 'text-xl font-medium text-gray-900 capitalize mb-3',
        children: 'locations',
      }),
      props.physicalLocations.length > 0
        ? _jsx(PhysicalLocationsFound, __assign({}, props))
        : _jsx(NoPhysicalLocations, __assign({}, props)),
    ],
  });
}
