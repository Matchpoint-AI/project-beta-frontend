...
export default function UserBrandData({ data }: { data: BrandData }) {
   if (!data) {
      return (
         <p className="text-[#111928] text-center">Did not setup a brand yet</p>
      );
   }
      ...
      <div className="p-5 flex gap-10 sm:flex-row flex-col items-center bg-white rounded-md">
         ...
         <div className="flex-grow flex items-center justify-between flex-wrap">
            <div>
               ...
               <p className="font-medium text-[#111928] mr-2 md:mb-0 mb-3">
                  {data.name}
               </p>
            </div>
            <div>
            ...
            <div>
               ...
               <p className="font-medium text-[#111928] capitalize mr-2 md:mb-0 mb-3">
                  {data.industry}
               </p>
            </div>
            <div>
