...
export default function BrandDataLoader(_a) {
  ...
  useEffect(
    function () {
      if (!profile || !(profile === null || profile === void 0 ? void 0 : profile.token)) return;
          ...
          return __generator(this, function (_g) {
            switch (_g.label) {
              ...
              case 2:
                data = _g.sent();
                if (data.length > 0) {
                  convertedValues = convertToChipsArray(
                    (data[0].brand_variables.values || []).filter(Boolean)
                  );
                  convertedPersona = convertToChipsArray(
                    (data[0].brand_variables.persona || []).filter(Boolean)
                  );
                  convertedToneAndVoice = convertToChipsArray(
                  ...
                  setBusinessInfo({
                    ...
                    brandColors:
                      ((_a = data[0].brand_variables.colors) === null || _a === void 0
                        ? void 0
                        : _a.slice(0, 3)) || [],
                    ...
                    product_features:
                      (_b = data[0].brand_variables.product_features) !== null && _b !== void 0
                        ? _b
                        : [],
                    product_description:
                      (_c = data[0].brand_variables.product_description) !== null && _c !== void 0
                        ? _c
                        : '',
                    product_link:
                      (_d = data[0].brand_variables.product_link) !== null && _d !== void 0
                        ? _d
                        : '',
                    start_date:
                      (_e = data[0].brand_variables.start_date) !== null && _e !== void 0 ? _e : '',
                    durationNum:
                      (_f = data[0].brand_variables.durationNum) !== null && _f !== void 0 ? _f : 0,
