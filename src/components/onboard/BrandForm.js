...
var BrandForm = function (_a) {
  ...
  var _c = useState([]),
    selectedColors = _c[0],
    setSelectedColors = _c[1];
  var _d = useState(false),
    colorPickerVisibility = _d[0],
    setColorPickerVisibility = _d[1];
  ...
  var removeColor = function (index) {
    var updatedColors = selectedColors.filter(function (color) {
      return color !== selectedColors[index];
    });
    setSelectedColors(updatedColors);
    setBusinessInfo(__assign(__assign({}, businessInfo), { brandColors: updatedColors }));
  };
  var extractBrandInfo = function (guideLines) {
          ...
          case 0:
            ...
            return [
              ...
              fetch(endpointUrl, {
                ...
                body: JSON.stringify({
                  prompt: "from this brand guidelines '".concat(
                    guideLines,
                    "' extract information about the brand and return anything you find in paired JSON output following this structure {\n\t\t\t\tcolors: {\n\t\t\t\t\tprimary: ['#000000', '#000000', '#000000', '#000000],\n\t\t\t\t\tsecondary: ['#000000', '#000000', '#000000']\n\t\t\t\t},\n\t\t\t\ttypography: {\n\t\t\t\t\tprimary: ['arial', 'helvetica'],\n\t\t\t\t\tsecondary: ['times new roman', 'roboto']\n\t\t\t\t},\n\t\t\t\tphotography: ['candid', 'screenshots']\n\t\t\t  }"
                  ),
                  json_mode: true,
                }),
              }),
          ...
          case 2:
            ...
            setSelectedColors(function (old) {
              ...
              var newColors = __spreadArray(
                __spreadArray(
                  ...
                  (_b =
                    (_a =
                      parsedContent === null || parsedContent === void 0
                        ? void 0
                        : parsedContent.colors) === null || _a === void 0
                      ? void 0
                ...
                (_d =
                  (_c =
                    parsedContent === null || parsedContent === void 0
                      ? void 0
                      : parsedContent.colors) === null || _c === void 0
                    ? void 0
            ...
            setBusinessInfo(
              __assign(__assign({}, businessInfo), {
                brandColors: __spreadArray(
                  __spreadArray(
                    __spreadArray([], selectedColors, true),
                    (_b =
                      (_a =
                        parsedContent === null || parsedContent === void 0
                          ? void 0
  ...
  var handleGuidelines = function (file) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 6:
            ...
            return [3 /*break*/, 3];
          case 7:
            return [4 /*yield*/, extractBrandInfo(extractedText)];
          case 8:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  return _jsxs(_Fragment, {
    children: [
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('label', {
                  ...
                  children: ['1. Add your brand guidelines (PDF, etc)', ' '],
                }),
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    analysePdf &&
                      _jsx(CircularProgress, { sx: { color: '#5145CD' }, size: 25, thickness: 5 }),
                  ],
                }),
                _jsx('p', {
                  className: 'py-1 text-xs text-[#6B7280]',
                  children: 'Upload your brand guidelines. Supported files: pdf',
                }),
              ],
            }),
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('p', {
                  className: 'py-1 text-xs text-[#6B7280]',
                  children: 'Supported files: png, jpeg, jpg',
                }),
              ],
            }),
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx('p', {
                  className: 'py-2 text-xs text-[#6B7280]',
                  children:
                    "We've detected these are your colors. If you'd like to change these please click each color or add more up to 2 colors total",
                }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('button', {
                          ...
                          onClick: function () {
                            return setColorPickerVisibility(function (old) {
                              return !old;
                            });
                          },
                          className: 'w-10 aspect-square rounded-full '.concat(
                            selectedColors.length >= 2 ? 'bg-gray-500' : 'bg-[#5145CD]',
                            ' flex items-center justify-center'
                          ),
                          children: _jsx(LuPlus, { color: '#fff', size: 20 }),
                        }),
                    ...
                    _jsx('div', {
                      ...
                      children: selectedColors.map(function (color, index) {
                        return _jsx(
                          ColorSpan,
                          { index: index, color: color, removeColor: removeColor },
                          index
                        );
                      }),
                    }),
      ...
      _jsx('div', {
        className: 'mb-5 md:min-w-[400px] w-full',
        children: _jsx('p', {
          className: 'text-xs text-[#6B7280]',
          children:
            'By clicking "Next", you represent and warrant that you own or have permission to use all the content from these websites and documents.',
        }),
      }),
      _jsxs('div', {
        className: 'flex justify-between mb-10 w-full',
        children: [
          _jsx(BackButton, { text: 'Back', onClick: handleBack }),
          _jsx(NextButton, { text: 'Next', formId: 'brand_form' }),
        ],
      }),
    ],
  });
