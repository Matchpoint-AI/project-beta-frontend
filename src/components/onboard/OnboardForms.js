...
var Onboard = function (_a) {
  ...
  var _f = useState(false),
    saveAndStart = _f[0],
    setSaveAndStart = _f[1];
  var endpointUrl = getServiceURL('data');
  var navigate = useNavigate();
  var handleBack = function () {
    if (currentStep === 4) {
      setBusinessInfo(function (prev) {
        return __assign(__assign({}, prev), { summary: undefined, product_features: undefined });
      });
    }
    if (currentStep > 2) {
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          case 0:
            ...
            cleanBusinessInfo = __assign(__assign({}, businessInfo), {
              ...
              toneAndVoice:
                (_b = businessInfo.toneAndVoice) === null || _b === void 0
                  ? void 0
                  : _b
                      .filter(function (t) {
                        return t === null || t === void 0 ? void 0 : t.selected;
              ...
              persona:
                (_c = businessInfo.persona) === null || _c === void 0
                  ? void 0
                  : _c
                      .filter(function (t) {
                        return t === null || t === void 0 ? void 0 : t.selected;
              ...
              type:
                (_d =
                  businessInfo === null || businessInfo === void 0
                    ? void 0
                    : businessInfo.brandLogo) === null || _d === void 0
                  ? void 0
                  : _d.type,
              fileName:
                (_e =
                  businessInfo === null || businessInfo === void 0
                    ? void 0
                    : businessInfo.brandLogo) === null || _e === void 0
                  ? void 0
                  : _e.name,
            };
            _j.label = 2;
          case 2:
              ...
              brand_variables: {
                ...
                values:
                  (_f =
                    businessInfo === null || businessInfo === void 0
                      ? void 0
                      : businessInfo.values) === null || _f === void 0
                    ? void 0
                    : _f
                        .filter(function (t) {
                          return t === null || t === void 0 ? void 0 : t.selected;
                ...
                tov:
                  (_g =
                    businessInfo === null || businessInfo === void 0
                      ? void 0
                      : businessInfo.toneAndVoice) === null || _g === void 0
                    ? void 0
                    : _g
                        .filter(function (t) {
                          return t === null || t === void 0 ? void 0 : t.selected;
                ...
                persona:
                  (_h =
                    businessInfo === null || businessInfo === void 0
                      ? void 0
                      : businessInfo.persona) === null || _h === void 0
                    ? void 0
                    : _h
                        .filter(function (t) {
                          return t === null || t === void 0 ? void 0 : t.selected;
                ...
                locations:
                  businessInfo === null || businessInfo === void 0
                    ? void 0
                    : businessInfo.physical_locations,
                isFetched:
                  businessInfo === null || businessInfo === void 0
                    ? void 0
                    : businessInfo.locations_fetched,
                checkzip:
                  businessInfo === null || businessInfo === void 0 ? void 0 : businessInfo.checkZip,
                summary:
                  businessInfo === null || businessInfo === void 0 ? void 0 : businessInfo.summary,
                scenes:
                  businessInfo === null || businessInfo === void 0 ? void 0 : businessInfo.scenes,
                themes:
                  businessInfo === null || businessInfo === void 0 ? void 0 : businessInfo.themes,
                negative_prompts:
                  businessInfo === null || businessInfo === void 0
                    ? void 0
                    : businessInfo.negative_prompts,
                product_features:
                  businessInfo === null || businessInfo === void 0
                    ? void 0
                    : businessInfo.product_features,
              },
              logo: logoData,
            ...
            fetch(endpointUrl + '/api/v1/data/brand', {
              ...
              .then(function (data) {
                ...
                setBusinessInfo({
                  name:
                    (_a = data === null || data === void 0 ? void 0 : data.biz_variables) ===
                      null || _a === void 0
                      ? void 0
                      : _a.brand_name,
                  website:
                    (_b = data === null || data === void 0 ? void 0 : data.biz_variables) ===
                      null || _b === void 0
                      ? void 0
                      : _b.brand_website,
                  industry:
                    (_c = data === null || data === void 0 ? void 0 : data.biz_variables) ===
                      null || _c === void 0
                      ? void 0
                      : _c.industry,
                  vertical:
                    (_d = data === null || data === void 0 ? void 0 : data.biz_variables) ===
                      null || _d === void 0
                      ? void 0
                      : _d.vertical,
                  physical_locations:
                    (_e = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _e === void 0
                      ? void 0
                      : _e.locations,
                  locations_fetched:
                    (_f = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _f === void 0
                      ? void 0
                      : _f.isFetched,
                  checkZip:
                    (_g = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _g === void 0
                      ? void 0
                      : _g.checkZip,
                  brandColors:
                    (_h = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _h === void 0
                      ? void 0
                      : _h.colors,
                  values:
                    (_j = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _j === void 0
                      ? void 0
                      : _j.values,
                  toneAndVoice:
                    (_k = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _k === void 0
                      ? void 0
                      : _k.tov,
                  mission:
                    (_l = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _l === void 0
                      ? void 0
                      : _l.mission,
                  persona:
                    (_m = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _m === void 0
                      ? void 0
                      : _m.persona,
                  summary:
                    (_o = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _o === void 0
                      ? void 0
                      : _o.summary,
                  isSaved: true,
                  logo:
                    (_p = data === null || data === void 0 ? void 0 : data.biz_variables) ===
                      null || _p === void 0
                      ? void 0
                      : _p.brand_logo,
                  products:
                    (_q = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _q === void 0
                      ? void 0
                      : _q.products,
                  product_features:
                    (_r = data === null || data === void 0 ? void 0 : data.brand_variables) ===
                      null || _r === void 0
                      ? void 0
                      : _r.product_features,
                  id: data.id,
  ...
  return _jsxs('div', {
    className: 'flex h-full flex-col max-w-6xl mx-auto gap-2',
    children: [
      currentStep === 1 &&
        businessInfo.name === undefined &&
        _jsxs('div', {
          className: 'flex flex-col  mt-32 md:mt-16',
          children: [
            _jsxs('h1', {
              className: ' text-[#5145CD] text-2xl font-bold',
              children: [
                'Welcome to Matchpoint ',
                _jsx('span', {
                  className: 'capitalize',
                  children:
                    profile === null || profile === void 0 ? void 0 : profile.name.split(' ')[0],
                }),
                ", let's get started.",
              ],
            }),
            ...
            _jsxs('div', {
              className:
                'flex-wrap items-center justify-between grid grid-cols-1 md:grid-cols-3 gap-3',
              children: [
                _jsx(StepContainer, {
                  icon: '/briefcase.svg',
                  title: 'Business & Brand info',
                  children: 'Ensures your campaign content is unique to you',
                }),
                _jsx(StepContainer, {
                  icon: '/palette_active.svg',
                  title: 'Campaign Brief',
                  children: 'Creates a guide that keeps your campaign targeted and timely',
                }),
                _jsx(StepContainer, {
                  icon: '/notes.svg',
                  title: 'Campaign Content Review',
                  children: 'Allows you to review and tweak your content as you like',
                }),
              ],
            }),
          ],
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsx(OnboardStepsBar, { currentStep: currentStep, setStep: setCurrentStep }),
          }),
          _jsx('div', {
            ...
            children:
              ...
              _jsx(_Fragment, {
                children: _jsxs(CustomComponent, {
                  ...
                  children: [
                    currentStep === 1 && _jsx(BusinessForm, { handleNext: handleNext }),
                    currentStep === 2 &&
                      _jsx(BrandForm, { handleNext: handleNext, handleBack: handleBack }),
                    currentStep === 3 &&
                      _jsx(ReviewForm, {
