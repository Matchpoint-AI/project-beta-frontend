...
var scrapeProduct = function (url, name, description) {
  return __awaiter(void 0, void 0, void 0, function () {
    var endpointUrl, body, response, errorText, parsedContent, result, _error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          errorText = _a.sent();
          throw new Error(
            'HTTP error! status: '.concat(response.status, ', message: ').concat(errorText)
          );
        case 4:
