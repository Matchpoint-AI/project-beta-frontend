...
export default function WebsiteScrapingForm() {
  ...
  var _b = useState(0),
    runValidation = _b[0],
    setRunValidation = _b[1];
  var _c = useState({ count: 0, _error: false }),
    nameError = _c[0],
    setNameError = _c[1];
  var _d = useState({ count: 0, _error: false }),
    websiteError = _d[0],
    setWebsiteError = _d[1];
  var _e = useState(''),
    progressDescription = _e[0],
    setProgressDescription = _e[1];
  var _f = useState(false),
    scrapingError = _f[0],
    setScrapingError = _f[1];
