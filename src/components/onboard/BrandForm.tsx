      ...
      <>
            ...
            <form onSubmit={handleSubmit} id="brand_form">
               ...
               <div className="mb-5 w-full">
                  ...
                  <p className="py-2 text-xs text-[#6B7280]">
                     We&apos;ve detected these are your colors. If you&apos;d
                     like to change these please click each color or add more up
                     to 2 colors total
                  </p>
                  <div className="flex gap-3 mt-3 w-full">
                     <div className="relative w-10">
                        <button
                           ...
                           onClick={() =>
                              setColorPickerVisibility((old) => !old)
                           }
         ...
         <div className="mb-5 md:min-w-[400px] w-full">
            <p className="text-xs text-[#6B7280]">
               By clicking &quot;Next&quot;, you represent and warrant that you
               own or have permission to use all the content from these websites
               and documents.
            </p>
         </div>
