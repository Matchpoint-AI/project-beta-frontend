...
export function ConnectInstagram() {
    ...
    var handleConnect = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("".concat(getServiceURL('data'), "/api/v1/instagram"))];
                case 1:
                    res = _a.sent();
    ...
    return (_jsxs("button", { className: "\n        inline-flex justify-center items-center gap-2 \n        w-[250px] h-12 px-5 py-3 rounded-lg \n        bg-indigo-700 hover:bg-[#6875F5]", onClick: handleConnect, children: [_jsx(InstagramIcon, {}), _jsx("div", { className: "text-white text-sm font-medium leading-normal", children: "Connect with Instagram" })] }));
}
//# sourceMappingURL=ConnectToInstagram.js.map