...
declare class PerformanceApiClient {
    ...
    recordCostMetric(operation: string, model: string, cost: number, tokensUsed?: number): Promise<MetricResponse>;
    recordQualityMetric(operation: string, qualityScore: number, details?: Record<string, unknown>): Promise<MetricResponse>;
    ...
    trackOperation<T>(operationName: string, labels: Record<string, string> | undefined, operation: () => Promise<T>): Promise<T>;
