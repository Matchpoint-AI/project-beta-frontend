...
var PerformanceApiClient = /** @class */ (function () {
        ...
        return __awaiter(this, arguments, void 0, function (endpoint, options) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        token = _b.sent();
                        return [4 /*yield*/, fetch("".concat(this.baseUrl).concat(endpoint), __assign(__assign({}, options), { headers: __assign({ 'Content-Type': 'application/json', Authorization: "Bearer ".concat(token) }, options.headers) }))];
                    case 2:
                        response = _b.sent();
    ...
    PerformanceApiClient.prototype.makeRequestWithoutAuth = function (endpoint_1) {
        return __awaiter(this, arguments, void 0, function (endpoint, options) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(this.baseUrl).concat(endpoint), __assign(__assign({}, options), { headers: __assign({ 'Content-Type': 'application/json' }, options.headers) }))];
                    case 1:
                        response = _b.sent();
    ...
    PerformanceApiClient.prototype.recordMetric = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('/metrics', {
                        method: 'POST',
    ...
    PerformanceApiClient.prototype.recordCostMetric = function (operation_1, model_1, cost_1) {
        return __awaiter(this, arguments, void 0, function (operation, model, cost, tokensUsed) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest("/metrics/cost?".concat(params), {
                        method: 'POST',
                    })];
            });
        });
    ...
    PerformanceApiClient.prototype.resolveAlert = function (alertId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest("/alerts/".concat(alertId, "/resolve"), {
                        method: 'POST',
                    })];
            });
        });
    ...
    PerformanceApiClient.prototype.trackOperation = function (operationName_1) {
        return __awaiter(this, arguments, void 0, function (operationName, labels, operation) {
            var startTime, error, result, latency, _err_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.recordMetric({
                                metric_type: 'latency',
                                value: latency,
                    ...
                    case 4:
                        _err_1 = _a.sent();
                        error = _err_1 instanceof Error ? _err_1 : new Error(String(_err_1));
                        // Record error
                        return [4 /*yield*/, this.recordMetric({
    ...
    PerformanceApiClient.prototype.recordMultipleMetrics = function (requests) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                promises = requests.map(function (request) { return _this.recordMetric(request); });
        ...
        return __awaiter(this, arguments, void 0, function (hoursBack) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), latency = _a[0], errors = _a[1], costs = _a[2], quality = _a[3], alerts = _a[4];
                        return [2 /*return*/, { latency: latency, errors: errors, costs: costs, quality: quality, alerts: alerts }];
                }
            });
        });
    };
