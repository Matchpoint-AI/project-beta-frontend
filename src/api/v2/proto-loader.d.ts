...
export declare class ProtoLoader {
   ...
   */
  encodeMessage(packageName: string, messageName: string, data: unknown): Promise<Uint8Array>;
  /**
   * Decode a message - converts from Uint8Array to JSON
   */
  decodeMessage(packageName: string, messageName: string, buffer: Uint8Array): Promise<unknown>;
  /**
   * Convert a message to JSON
   */
  messageToJson(packageName: string, messageName: string, data: unknown): Promise<string>;
  /**
   * Parse JSON to a message
   */
  jsonToMessage(packageName: string, messageName: string, json: string): Promise<unknown>;
  /**
