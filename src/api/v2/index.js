 ...
 */
export function initializeV2Api() {
  return __awaiter(this, void 0, void 0, function () {
    var protoLoader, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, import('./proto-loader')];
        case 1:
          protoLoader = _a.sent().protoLoader;
          _a.label = 2;
        case 2:
          _a.trys.push([2, 4, , 5]);
          // Preload proto definitions
          return [4 /*yield*/, protoLoader.loadProtos()];
        case 3:
          // Preload proto definitions
          _a.sent();
          return [3 /*break*/, 5];
        case 4:
          error_1 = _a.sent();
          console.error('Failed to initialize V2 API:', error_1);
          return [3 /*break*/, 5];
        case 5:
          return [2 /*return*/];
      }
