    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this.post(
            '/campaigns/'.concat(campaignId, '/content'),
            request,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this.post(
            '/campaigns/'.concat(campaignId, '/approve'),
            request,
            { package: 'protos', message: 'Campaign' },
            { package: 'protos', message: 'Campaign' },
            { token: token }
  ...
  CampaignApiV2.prototype.getUserCampaigns = function (token, filters) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        endpoint = '/campaigns'.concat(
          queryParams.toString() ? '?'.concat(queryParams.toString()) : ''
        );
        return [
          2 /*return*/,
          this.get(endpoint, { package: 'protos', message: 'Campaign' }, { token: token }),
        ];
      });
    });
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.get(
            '/campaigns/'.concat(campaignId, '/generation/').concat(requestId, '/status'),
            { package: 'protos', message: 'GenerationRequest' },
            { token: token }
          ),
        ];
      ...
      return __generator(this, function (_a) {
        return [
          ...
          this.makeProtoRequest(
            'POST',
            '/campaigns/'.concat(campaignId, '/generation/').concat(requestId, '/cancel'),
            null,
            null,
            { package: 'protos', message: 'Empty' },
            { token: token }
        ...
        switch (_a.label) {
          case 0:
            return [
              ...
              fetch(
                ''
                  .concat(this.baseUrl, '/campaigns/')
                  .concat(campaignId, '/export?format=')
                  .concat(format),
                {
                  method: 'GET',
                  headers: {
