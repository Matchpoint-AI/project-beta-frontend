...
var ProtoService = /** @class */ (function () {
   ...
   */
  ProtoService.prototype.makeProtoRequest = function (
    method,
    endpoint,
    requestData,
    requestMessagePath,
    ...
    return __awaiter(this, void 0, void 0, function () {
      var url, headers, body, controller, timeout, timeoutId, response, json, error_1;
  ...
  ProtoService.prototype.get = function (endpoint, responseMessagePath, options) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.makeProtoRequest('GET', endpoint, null, null, responseMessagePath, options),
        ];
      });
    });
  };
   ...
   */
  ProtoService.prototype.post = function (
    endpoint,
    data,
    requestMessagePath,
    responseMessagePath,
   ...
   */
  ProtoService.prototype.put = function (
    endpoint,
    data,
    requestMessagePath,
    responseMessagePath,
  ...
  ProtoService.prototype.delete = function (endpoint, responseMessagePath, options) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.makeProtoRequest('DELETE', endpoint, null, null, responseMessagePath, options),
        ];
      });
    });
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            errorMessage = ''
              .concat(this.serviceName, ' API error: ')
