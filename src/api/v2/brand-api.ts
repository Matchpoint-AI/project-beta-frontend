...
export class BrandApiV2 extends ProtoService {
  ...
  async uploadLogo(
    ...
    const response = await fetch(
      `${this.baseUrl}/brands/${brandId}/logo`,
      {
        method: 'POST',
        headers: {
  ...
  async importBrandData(
    ...
    const response = await fetch(
      `${this.baseUrl}/brands/${brandId}/import`,
      {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
  ...
  async exportBrandData(
    ...
    const response = await fetch(
      `${this.baseUrl}/brands/${brandId}/export?format=${format}`,
      {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`
  ...
  async validateBrandData(
    ...
    return this.post<CreateBrandRequest, {
      valid: boolean;
      errors?: Record<string, string>;
      warnings?: Record<string, string>;
    }>(
