...
export declare class CampaignApiV2 extends ProtoService {
     ...
     */
    updateCampaign(campaignId: string, data: Omit<UpdateCampaignRequest, 'campaign_id'>, token: string): Promise<UpdateCampaignResponse>;
    /**
     * Generate content for a campaign
     */
    generateContent(campaignId: string, options: Omit<GenerateContentRequest, 'campaign_id'>, token: string): Promise<GenerateContentResponse>;
    /**
     ...
     * Approve a campaign
     */
    approveCampaign(campaignId: string, approvalNotes: string | undefined, token: string): Promise<ApproveCampaignResponse>;
    /**
     * Delete a campaign
     */
    deleteCampaign(campaignId: string, token: string): Promise<{
        success: boolean;
        message: string;
    }>;
    /**
     ...
     */
    getUserCampaigns(token: string, filters?: {
        status?: CampaignStatus;
        brand_id?: string;
        limit?: number;
        offset?: number;
     ...
     */
    getGenerationStatus(campaignId: string, requestId: string, token: string): Promise<GenerateContentResponse>;
    /**
     * Cancel content generation
     */
    cancelGeneration(campaignId: string, requestId: string, token: string): Promise<{
        success: boolean;
        message: string;
    }>;
    /**
