...
interface CostDashboardData {
    ...
    current_model_distribution: Record<string, {
        requests: number;
        cost: number;
        percentage: number;
    }>;
 ...
 */
export declare function fetchCostOptimizationData(startDate?: string, endDate?: string): Promise<CostDashboardData>;
/**
 ...
 */
export declare function fetchModelComparison(startDate?: string, endDate?: string): Promise<OptimizationComparison[]>;
/**
