export declare const captionApi: {
    generateCaptions: (contentId: string, data: {
    ...
    regenerateCaption: (contentId: string, captionId: string, data: {
    ...
    validateCaption: (data: {
        text: string;
        platform?: "instagram" | "facebook" | "twitter" | "linkedin";
    }, token: string) => Promise<any>;
};
export declare const policyApi: {
    createPolicy: (campaignId: string, data: {
        campaign_id: string;
    ...
    updatePolicy: (campaignId: string, policyId: string, data: unknown, token: string) => Promise<any>;
};
export declare const plannerApi: {
    createPlan: (campaignId: string, data: {
...
export declare const imageApi: {
    ...
    remixImage: (imageId: string, data: {
