    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [3 /*break*/, 11];
        case 1:
          return [4 /*yield*/, _axios.get('/'.concat(app), config)];
        case 2:
          response = _b.sent();
          return [3 /*break*/, 11];
        case 3:
          return [4 /*yield*/, _axios.get('/'.concat(app, '/data'), config)];
        case 4:
          response = _b.sent();
          return [3 /*break*/, 11];
        case 5:
          return [4 /*yield*/, _axios.delete('/'.concat(app), config)];
        case 6:
          response = _b.sent();
          return [3 /*break*/, 11];
        case 7:
          return [4 /*yield*/, _axios.get('/integrations', config)];
        case 8:
          response = _b.sent();
          return [3 /*break*/, 11];
        case 9:
          return [4 /*yield*/, _axios.get('/'.concat(app, '/me'), config)];
        case 10:
          response = _b.sent();
          return [3 /*break*/, 11];
        case 11:
