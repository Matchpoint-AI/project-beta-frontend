...
export function fetchCostOptimizationData(startDate, endDate) {
  return __awaiter(this, void 0, void 0, function () {
    var token, params, response, errorBody, data, error_1;
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            ...
            fetch(
              ''
                .concat(CONTENT_GEN_URL, '/api/v1/cost-optimization/dashboard?')
        ...
        case 3:
          ...
          throw new CostOptimizationApiError(
            'Failed to fetch cost optimization data: '.concat(response.statusText),
            response.status,
            errorBody
          );
        case 4:
        ...
        case 6:
          error_1 = _a.sent();
          if (error_1 instanceof CostOptimizationApiError) {
            throw error_1;
          }
          throw new CostOptimizationApiError(
            'Error fetching cost optimization data: '.concat(
...
export function trackApiUsage(usageData) {
  return __awaiter(this, void 0, void 0, function () {
    var token, response, errorBody, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 5, , 6]);
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            fetch(''.concat(CONTENT_GEN_URL, '/api/v1/cost-optimization/track'), {
              method: 'POST',
              headers: {
                Authorization: 'Bearer '.concat(token),
                'Content-Type': 'application/json',
        ...
        case 3:
          errorBody = _a.sent();
          throw new CostOptimizationApiError(
            'Failed to track API usage: '.concat(response.statusText),
            response.status,
            errorBody
          );
        case 4:
        ...
        case 5:
          error_2 = _a.sent();
          if (error_2 instanceof CostOptimizationApiError) {
            throw error_2;
          }
          throw new CostOptimizationApiError(
            'Error tracking API usage: '.concat(
...
export function fetchModelComparison(startDate, endDate) {
  return __awaiter(this, void 0, void 0, function () {
    var token, params, response, errorBody, error_3;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 6, , 7]);
        ...
        case 1:
          ...
          return [
            ...
            fetch(
              ''
                .concat(CONTENT_GEN_URL, '/api/v1/cost-optimization/model-comparison?')
                .concat(params.toString()),
              {
                method: 'GET',
                headers: {
        ...
        case 3:
          errorBody = _a.sent();
          throw new CostOptimizationApiError(
            'Failed to fetch model comparison: '.concat(response.statusText),
            response.status,
            errorBody
          );
        case 4:
        ...
        case 6:
          error_3 = _a.sent();
          if (error_3 instanceof CostOptimizationApiError) {
            throw error_3;
          }
          throw new CostOptimizationApiError(
            'Error fetching model comparison: '.concat(
...
export function exportCostData(startDate, endDate) {
  return __awaiter(this, void 0, void 0, function () {
    var token, params, response, errorBody, error_4;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 6, , 7]);
        ...
        case 1:
          ...
          return [
            ...
            fetch(
              ''
                .concat(CONTENT_GEN_URL, '/api/v1/cost-optimization/export?')
                .concat(params.toString()),
              {
                method: 'GET',
                headers: {
        ...
        case 3:
          errorBody = _a.sent();
          throw new CostOptimizationApiError(
            'Failed to export cost data: '.concat(response.statusText),
            response.status,
            errorBody
          );
        case 4:
        ...
        case 6:
          error_4 = _a.sent();
          if (error_4 instanceof CostOptimizationApiError) {
            throw error_4;
          }
          throw new CostOptimizationApiError(
            'Error exporting cost data: '.concat(
...
export function updateOptimizationSettings(settings) {
  return __awaiter(this, void 0, void 0, function () {
    var token, response, errorBody, error_5;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 5, , 6]);
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            fetch(''.concat(CONTENT_GEN_URL, '/api/v1/cost-optimization/settings'), {
              method: 'PUT',
              headers: {
                Authorization: 'Bearer '.concat(token),
                'Content-Type': 'application/json',
        ...
        case 3:
          errorBody = _a.sent();
          throw new CostOptimizationApiError(
            'Failed to update optimization settings: '.concat(response.statusText),
            response.status,
            errorBody
          );
        case 4:
        ...
        case 5:
          error_5 = _a.sent();
          if (error_5 instanceof CostOptimizationApiError) {
            throw error_5;
          }
          throw new CostOptimizationApiError(
            'Error updating optimization settings: '.concat(
...
function transformDashboardData(data) {
  ...
  return {
    period_start:
      typeof (safeData === null || safeData === void 0 ? void 0 : safeData.period_start) ===
      'string'
        ? safeData.period_start
        : new Date().toISOString(),
    period_end:
      typeof (safeData === null || safeData === void 0 ? void 0 : safeData.period_end) === 'string'
        ? safeData.period_end
        : new Date().toISOString(),
    total_baseline_cost:
      typeof (safeData === null || safeData === void 0 ? void 0 : safeData.total_baseline_cost) ===
      'number'
        ? safeData.total_baseline_cost
        : 0,
    total_optimized_cost:
      typeof (safeData === null || safeData === void 0 ? void 0 : safeData.total_optimized_cost) ===
      'number'
        ? safeData.total_optimized_cost
        : 0,
    total_absolute_savings:
      typeof (safeData === null || safeData === void 0
        ? void 0
        : safeData.total_absolute_savings) === 'number'
        ? safeData.total_absolute_savings
        : 0,
    total_percentage_savings:
      typeof (safeData === null || safeData === void 0
        ? void 0
        : safeData.total_percentage_savings) === 'number'
        ? safeData.total_percentage_savings
        : 0,
    projected_annual_savings:
      typeof (safeData === null || safeData === void 0
        ? void 0
        : safeData.projected_annual_savings) === 'number'
        ? safeData.projected_annual_savings
        : 0,
    optimization_metrics: Array.isArray(
      safeData === null || safeData === void 0 ? void 0 : safeData.optimization_metrics
    )
    ...
    current_model_distribution:
      typeof (safeData === null || safeData === void 0
        ? void 0
        : safeData.current_model_distribution) === 'object'
        ? safeData.current_model_distribution
        : {},
    daily_savings: Array.isArray(
      safeData === null || safeData === void 0 ? void 0 : safeData.daily_savings
    )
      ? safeData.daily_savings
      : [],
    optimization_recommendations: Array.isArray(
      safeData === null || safeData === void 0 ? void 0 : safeData.optimization_recommendations
    )
