        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    throw new CostOptimizationApiError("Error fetching cost optimization data: ".concat(error instanceof Error ? error.message : 'Unknown error'), undefined, error);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    throw new CostOptimizationApiError("Error tracking API usage: ".concat(error instanceof Error ? error.message : 'Unknown error'), undefined, error);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    throw new CostOptimizationApiError("Error fetching model comparison: ".concat(error instanceof Error ? error.message : 'Unknown error'), undefined, error);
                case 7: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    throw new CostOptimizationApiError("Error exporting cost data: ".concat(error instanceof Error ? error.message : 'Unknown error'), undefined, error);
                case 7: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    throw new CostOptimizationApiError("Error updating optimization settings: ".concat(error instanceof Error ? error.message : 'Unknown error'), undefined, error);
                case 6: return [2 /*return*/];
            }
        });
    });
