...
// Mock the API module
vi.mock('../../api/costOptimizationApi', function () { return ({
    costOptimizationApi: {
        getDashboardData: vi.fn(),
    },
}); });
// Mock Chart.js components
vi.mock('react-chartjs-2', function () { return ({
    Line: vi.fn(function (_a) {
        var _data = _a.data, _options = _a.options;
        return (_jsx("div", { "data-testid": "line-chart", "data-chart-type": "line", children: "Mock Line Chart" }));
    }),
    Bar: vi.fn(function (_a) {
        var _data = _a.data, _options = _a.options;
        return (_jsx("div", { "data-testid": "bar-chart", "data-chart-type": "bar", children: "Mock Bar Chart" }));
    }),
    Doughnut: vi.fn(function (_a) {
        var _data = _a.data, _options = _a.options;
        return (_jsx("div", { "data-testid": "doughnut-chart", "data-chart-type": "doughnut", children: "Mock Doughnut Chart" }));
    }),
}); });
// Mock UI components
vi.mock('../ui/LoadingSpinner', function () { return ({
    LoadingSpinner: vi.fn(function (_a) {
        var size = _a.size;
        return (_jsx("div", { "data-testid": "loading-spinner", "data-size": size, children: "Loading..." }));
    }),
}); });
vi.mock('../ui/Card', function () { return ({
    Card: vi.fn(function (_a) {
        var children = _a.children, className = _a.className, props = __rest(_a, ["children", "className"]);
        return (_jsx("div", __assign({ "data-testid": "card", className: className }, props, { children: children })));
    }),
}); });
vi.mock('../ui/Badge', function () { return ({
...
vi.mock('../ui/Button', function () { return ({
    Button: vi.fn(function (_a) {
        var children = _a.children, onClick = _a.onClick, variant = _a.variant, size = _a.size, props = __rest(_a, ["children", "onClick", "variant", "size"]);
        return (_jsx("button", __assign({ "data-testid": "button", onClick: onClick, "data-variant": variant, "data-size": size }, props, { children: children })));
    }),
}); });
...
describe('CostOptimizationDashboard', function () {
    ...
    describe('Initial Loading', function () {
        it('should show loading spinner initially', function () {
            costOptimizationApi.getDashboardData.mockImplementation(function () { return new Promise(function () { }); });
            render(_jsx(CostOptimizationDashboard, {}));
            expect(screen.getByTestId('loading-spinner')).toBeInTheDocument();
            expect(screen.getByText('Loading...')).toBeInTheDocument();
        });
        it('should call API with default parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Data Display', function () {
        ...
        it('should display dashboard title and description', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should display key metrics cards', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should display optimization status cards', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should display badge status correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
                        return [4 /*yield*/, waitFor(function () {
                                ...
                                expect(badges.some(function (badge) {
                                    return badge.textContent === 'On Track' && badge.getAttribute('data-variant') === 'success';
                                })).toBe(true);
        ...
        it('should render charts', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should display cost alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should display top savings opportunities', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
                        return [4 /*yield*/, waitFor(function () {
                                ...
                                expect(savingsText.some(function (el) { var _a; return (_a = el.textContent) === null || _a === void 0 ? void 0 : _a.includes('$57,135'); })).toBe(true);
                                expect(savingsText.some(function (el) { var _a; return (_a = el.textContent) === null || _a === void 0 ? void 0 : _a.includes('$24,422'); })).toBe(true);
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    describe('User Interactions', function () {
        ...
        it('should handle time range selection', function () { return __awaiter(void 0, void 0, void 0, function () {
            var select;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should handle optimization card clicks', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
    ...
    describe('Error Handling', function () {
        it('should display error message on API failure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        render(_jsx(CostOptimizationDashboard, {}));
                        return [4 /*yield*/, waitFor(function () {
                                expect(screen.getByText("Error loading cost dashboard: ".concat(errorMessage))).toBeInTheDocument();
        ...
        it('should handle retry after error', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should handle unknown error types', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Data Formatting', function () {
        ...
        it('should format currency values correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should format percentage values correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should apply correct color coding for savings', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
    ...
    describe('Responsive Design', function () {
        ...
        it('should apply responsive grid classes', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
                        return [4 /*yield*/, waitFor(function () {
                                ...
                                var visionElements = screen.getAllByText('Vision Model Switch');
                                var optimizationGrid = visionElements[0].closest('.grid');
    ...
    describe('Accessibility', function () {
        ...
        it('should have proper heading structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
        ...
        it('should have accessible form controls', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(CostOptimizationDashboard, {}));
    ...
    describe('Chart Data Preparation', function () {
        ...
        it('should prepare line chart data correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var Line;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import('react-chartjs-2')];
                    case 1:
                        Line = (_a.sent()).Line;
                        render(_jsx(CostOptimizationDashboard, {}));
                        return [4 /*yield*/, waitFor(function () {
        ...
        it('should prepare bar chart data correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var Bar;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import('react-chartjs-2')];
        ...
        it('should prepare doughnut chart data correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
            var Doughnut;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import('react-chartjs-2')];
    ...
    describe('Edge Cases', function () {
        ...
        it('should handle empty optimization metrics', function () { return __awaiter(void 0, void 0, void 0, function () {
            var emptyData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, waitFor(function () {
                                ...
                                var optimizationCards = screen.queryAllByText(/Vision Model Switch|Gemini Routing/);
        ...
        it('should handle missing optional data fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            var incompleteData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        incompleteData = __assign(__assign({}, mockDashboardData), { optimization_metrics: [
                                __assign(__assign({}, mockDashboardData.optimization_metrics[0]), { quality_impact: null, latency_impact: null }),
                            ] });
        ...
        it('should handle zero or negative savings', function () { return __awaiter(void 0, void 0, void 0, function () {
            var negativeData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        negativeData = __assign(__assign({}, mockDashboardData), { total_percentage_savings: -5.0, total_absolute_savings: -500.0 });
