...
export var brandKnowledgeApi = {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(''.concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge'), {
                method: 'POST',
                headers: {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(''.concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge/').concat(id), {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                  Authorization: 'Bearer '.concat(token),
   ...
   */
  getByBrandId: function (brandId, token) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, error;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(
                ''.concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge/by-brand/').concat(brandId),
                {
                  headers: {
                    Authorization: 'Bearer '.concat(token),
                  },
  ...
  list: function (token_1) {
    ...
    return __awaiter(
      void 0,
      __spreadArray([token_1], args_1, true),
      void 0,
      function (token, limit, offset) {
        var response, error;
        if (limit === void 0) {
          limit = 10;
        }
          ...
          switch (_a.label) {
            case 0:
              return [
                ...
                fetch(
                  ''
                    .concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge?limit=')
                    .concat(limit, '&offset=')
                    .concat(offset),
                  {
                    headers: {
   ...
   */
  extractFromCampaign: function (campaignId, token) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, error;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(''.concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge/extract-from-campaign'), {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
                  Authorization: 'Bearer '.concat(token),
   ...
   */
  extractFromCampaigns: function (campaignIds, token) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, error;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(''.concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge/extract-from-campaigns'), {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
                  Authorization: 'Bearer '.concat(token),
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fetch(''.concat(CONTENT_GEN_URL, '/api/v1/brand-knowledge/summary'), {
                headers: {
                  Authorization: 'Bearer '.concat(token),
                },
              }),
