...
var BrandApiV2 = /** @class */ (function (_super) {
    ...
    BrandApiV2.prototype.createBrand = function (data, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.post('/brands', data, { package: 'protos', message: 'Brand' }, { package: 'protos', message: 'Brand' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.getBrand = function (brandId, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get("/brands/".concat(brandId), { package: 'protos', message: 'Brand' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.updateBrand = function (brandId, data, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.put("/brands/".concat(brandId), request, { package: 'protos', message: 'Brand' }, { package: 'protos', message: 'Brand' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.deleteBrand = function (brandId, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.delete("/brands/".concat(brandId), { package: 'protos', message: 'Empty' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.getUserBrands = function (token, filters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                endpoint = "/brands".concat(queryParams.toString() ? "?".concat(queryParams.toString()) : '');
                return [2 /*return*/, this.get(endpoint, { package: 'protos', message: 'Brand' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.createBrandKnowledge = function (data, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.post("/brands/".concat(data.brand_id, "/knowledge"), data, { package: 'protos', message: 'BrandKnowledge' }, { package: 'protos', message: 'BrandKnowledge' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.getBrandKnowledge = function (brandId, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get("/brands/".concat(brandId, "/knowledge"), { package: 'protos', message: 'BrandKnowledge' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.updateBrandKnowledge = function (brandId, knowledgeId, data, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.put("/brands/".concat(brandId, "/knowledge/").concat(knowledgeId), request, { package: 'protos', message: 'BrandKnowledge' }, { package: 'protos', message: 'BrandKnowledge' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.crawlWebsite = function (data, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.post("/brands/".concat(data.brand_id, "/crawl"), data, { package: 'protos', message: 'CrawlRequest' }, { package: 'protos', message: 'CrawlJob' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.getCrawlStatus = function (brandId, jobId, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get("/brands/".concat(brandId, "/crawl/").concat(jobId), { package: 'protos', message: 'CrawlJob' }, { token: token })];
            });
        });
    };
    /**
    ...
    BrandApiV2.prototype.extractBrandInfo = function (data, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.post("/brands/".concat(data.brand_id, "/extract"), data, { package: 'protos', message: 'ExtractRequest' }, { package: 'protos', message: 'ExtractResponse' }, { token: token })];
            });
        });
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("".concat(this.baseUrl, "/brands/").concat(brandId, "/logo"), {
                                method: 'POST',
                                headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("".concat(this.baseUrl, "/brands/").concat(brandId, "/import"), {
                                method: 'POST',
                                headers: {
                                    Authorization: "Bearer ".concat(token),
                                },
    ...
    BrandApiV2.prototype.exportBrandData = function (brandId, format, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(this.baseUrl, "/brands/").concat(brandId, "/export?format=").concat(format), {
                            method: 'GET',
                            headers: {
                                Authorization: "Bearer ".concat(token),
                            },
    ...
    BrandApiV2.prototype.validateBrandData = function (data, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.post('/brands/validate', data, { package: 'protos', message: 'Brand' }, { package: 'protos', message: 'ValidationResponse' }, { token: token })];
            });
        });
    };
    return BrandApiV2;
