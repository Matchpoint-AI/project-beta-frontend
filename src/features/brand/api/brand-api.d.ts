...
export declare class BrandApiV2 extends ProtoService {
     ...
     */
    updateBrand(brandId: string, data: Omit<UpdateBrandRequest, 'brand_id'>, token: string): Promise<Brand>;
    /**
     * Delete a brand
     */
    deleteBrand(brandId: string, token: string): Promise<{
        success: boolean;
        message: string;
    }>;
    /**
     ...
     */
    getUserBrands(token: string, filters?: {
        industry?: string;
        limit?: number;
        offset?: number;
    }): Promise<{
     ...
     */
    updateBrandKnowledge(brandId: string, knowledgeId: string, data: Omit<UpdateBrandKnowledgeRequest, 'brand_id' | 'knowledge_id'>, token: string): Promise<BrandKnowledge>;
    /**
     ...
     * Upload brand logo
     */
    uploadLogo(brandId: string, file: File, token: string): Promise<{
        logo_url: string;
    }>;
    /**
     * Import brand data from file
     */
    importBrandData(brandId: string, file: File, format: 'json' | 'csv' | 'xlsx', token: string): Promise<{
        success: boolean;
     ...
     * Validate brand data
     */
    validateBrandData(data: CreateBrandRequest, token: string): Promise<{
        valid: boolean;
