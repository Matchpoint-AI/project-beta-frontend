...
export var BrandKnowledgePage = function () {
    ...
    var handleNext = function () {
        if (activeStep === steps.length - 1) {
            ...
            setActiveStep(function (prevStep) { return prevStep + 1; });
        }
    };
    ...
    var handleSave = function (_data) {
        // Additional logic for handling saved data
    };
    return (_jsx(Container, { maxWidth: "lg", children: _jsxs(Box, { sx: { mt: 4, mb: 4 }, children: [_jsx(Typography, { variant: "h3", component: "h1", gutterBottom: true, align: "center", children: "Brand Knowledge Management" }), _jsx(Stepper, { activeStep: activeStep, sx: { mb: 4 }, children: steps.map(function (label) { return (_jsx(Step, { children: _jsx(StepLabel, { children: label }) }, label)); }) }), _jsx(BrandKnowledgeForm, { handleNext: handleNext, handleBack: handleBack, onSave: handleSave })] }) }));
};
