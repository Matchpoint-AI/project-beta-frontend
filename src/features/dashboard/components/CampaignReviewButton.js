...
export default function CampaignReviewButton(_a) {
  ...
  var handleCampaignBrief = function () {
    var _a, _b;
    var data =
      (_a = campaign === null || campaign === void 0 ? void 0 : campaign.campaign_data) === null ||
      _a === void 0
        ? void 0
    ...
    setCampaignInfo(function (prev) {
      return __assign(__assign({}, prev), {
        ...
        campaign_id: campaign === null || campaign === void 0 ? void 0 : campaign.campaign_id,
        campaign_brief: true,
        created_at: campaign === null || campaign === void 0 ? void 0 : campaign.timestamp,
      });
    });
    handleNavigate(
      (_b = profile === null || profile === void 0 ? void 0 : profile.id) !== null && _b !== void 0
        ? _b
        : '',
      '/campaign',
      navigate
  ...
  return _jsx('button', {
    ...
    className:
      'text-[#5145CD] border self-end border-[#5145CD] text-sm px-2 py-1 rounded-md mr-2  h-9',
