...
vi.mock('../shared/Sidebar', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "sidebar", children: "Sidebar" }); },
}); });
vi.mock('../PromotionComponent', function () { return ({
    default: function (_a) {
        var campaign = _a.campaign, status = _a.status;
        return (_jsxs("div", { "data-testid": "promotion-component", children: [_jsx("span", { "data-testid": "campaign-id", children: campaign.campaign_id }), _jsx("span", { "data-testid": "campaign-status", children: status })] }));
    },
}); });
vi.mock('../shared/Dropdown', function () { return ({
    default: function (_a) {
        var currentValue = _a.currentValue, onUpdateContext = _a.onUpdateContext, options = _a.options;
        return (_jsx("select", { "data-testid": "campaign-filter-dropdown", value: currentValue, onChange: function (e) { return onUpdateContext(e.target.value); }, children: options.map(function (option) { return (_jsx("option", { value: option, children: option }, option)); }) }));
    },
}); });
vi.mock('./EmptyDashboard', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "empty-dashboard", children: "No campaigns" }); },
}); });
var mockNavigate = vi.fn();
vi.mock('react-router-dom', function () { return __awaiter(void 0, void 0, void 0, function () {
    var actual;
...
var createMockCampaign = function (id, status, timestamp) { return ({
    campaign_id: id,
...
var renderWithContext = function (campaigns, campaignType, _setCampaignType) {
    if (campaigns === void 0) { campaigns = []; }
    if (campaignType === void 0) { campaignType = 'All'; }
    if (_setCampaignType === void 0) { _setCampaignType = vi.fn(); }
    return render(_jsx(BrowserRouter, { children: _jsx(AuthContext.Provider, { value: mockAuthContextValue, children: _jsx(CampaignContext.Provider, { value: mockCampaignContextValue, children: _jsx(BrandContext.Provider, { value: mockBrandContextValue, children: _jsx(CampaignsList, { campaigns: campaigns, campaignType: campaignType, setCampaignType: _setCampaignType }) }) }) }) }));
};
describe('CampaignsList Component', function () {
    ...
    it('should handle New Campaign button click', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should clear campaign info when New Campaign is clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockSetCampaignInfo, campaignContextWithSetInfo, campaigns, newCampaignButton;
        return __generator(this, function (_a) {
            mockSetCampaignInfo = vi.fn();
            campaignContextWithSetInfo = __assign(__assign({}, mockCampaignContextValue), { setCampaignInfo: mockSetCampaignInfo });
            campaigns = [createMockCampaign('campaign-1', 'ACTIVE')];
            render(_jsx(BrowserRouter, { children: _jsx(AuthContext.Provider, { value: mockAuthContextValue, children: _jsx(CampaignContext.Provider, { value: campaignContextWithSetInfo, children: _jsx(BrandContext.Provider, { value: mockBrandContextValue, children: _jsx(CampaignsList, { campaigns: campaigns, campaignType: "All", setCampaignType: vi.fn() }) }) }) }) }));
            newCampaignButton = screen.getByText('New Campaign');
            fireEvent.click(newCampaignButton);
