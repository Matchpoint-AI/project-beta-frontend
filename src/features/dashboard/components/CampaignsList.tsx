      ...
      const computeStatuses = () => {
         ...
         uniqueCampaigns.forEach((campaign) => {
            ...
            if (status === "DRAFT") {
               ...
               const { start_date, durationNum } =
                  campaign_data.campaign_variables;
               const startDate = new Date(start_date);
               const durationInMilliseconds =
                  durationNum * 7 * 24 * 60 * 60 * 1000; // Convert weeks to milliseconds
               ...
               <div className="flex sm:flex-row flex-col justify-between mb-5">
                  <div className="flex-col gap-4">
                     ...
                     <p className="my-2 text-base text-black">
                        Check out the campaigns you&apos;ve created with
                        Matchpoint below. Click any one of them to see your
                        content.
                     </p>
                  </div>
                  <button
