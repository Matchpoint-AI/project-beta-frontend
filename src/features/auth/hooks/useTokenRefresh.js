...
export var useTokenRefresh = function () {
    var _a = useAuth(), profile = _a.profile, setProfile = _a.setProfile, logout = _a.logout;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4: return [2 /*return*/, newToken];
                case 5:
                    _error_1 = _a.sent();
    ...
    var fetchWithTokenRefresh = function (url_1) {
        ...
        return __awaiter(void 0, __spreadArray([url_1], args_1, true), void 0, function (url, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makeRequest = function (token) { return __awaiter(void 0, void 0, void 0, function () {
                            var headers;
                            return __generator(this, function (_a) {
                                ...
                                return [2 /*return*/, fetch(url, __assign(__assign({}, options), { headers: headers }))];
                            });
                        }); };
                        return [4 /*yield*/, makeRequest(profile === null || profile === void 0 ? void 0 : profile.token)];
                    case 1:
                        response = _a.sent();
