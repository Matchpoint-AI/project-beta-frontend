...
export default function VerifyEmail(_a) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(''.concat(endpointUrl, '/api/v1/user/resend-verification'), {
                method: 'POST',
                headers: {
  ...
  return _jsxs('div', {
    className:
      'flex flex-col items-center justify-center py-20 bg-gradient-to-br from-[#F9D2FF] to-[#8DA6FF] min-h-screen',
    children: [
      loading &&
        _jsxs(_Fragment, {
          children: [
            _jsx(CircularProgress, { sx: { color: '#30175A' }, size: 64, thickness: 4 }),
            _jsx('h1', {
              className:
                'font-medium md:text-[36px] sm:text-[28px] text-[20px] text-center text-[#30175A] capitalize mt-5',
              children: 'We are Verifying Your Email ...',
            }),
          ],
        }),
      verified &&
        _jsxs(_Fragment, {
          children: [
            _jsx(IoMdCheckmarkCircleOutline, { size: 64, color: '#30175A' }),
            _jsx('h1', {
              className:
            ...
            _jsx('p', {
              ...
              children:
                'Thank you for verifying your email address! Your account is now fully activated, and you can explore all our features.',
            }),
            _jsx(Link, {
              to: '/login',
      ...
      error &&
        _jsxs(_Fragment, {
          children: [
            ...
            _jsx('h1', {
              className:
                'font-medium md:text-[42px] sm:text-[32px] text-[28px] text-center text-[#30175A] capitalize',
              children: 'Error verifying your email',
            }),
            _jsxs('p', {
              className: 'text-[#30175A] md:text-lg text-base text-center max-w-[600px]',
              children: [
            ...
            _jsx('button', {
              className:
                'flex items-center justify-center font-semibold mt-5 bg-[#5145CD] text-white rounded-lg w-[95%] max-w-[120px] min-h-[50px]',
              onClick: resendVerification,
              children: resendLoading
                ? _jsx(CircularProgress, { sx: { color: '#fff' }, size: 25, thickness: 5 })
                : 'Resend',
            }),
          ],
        }),
