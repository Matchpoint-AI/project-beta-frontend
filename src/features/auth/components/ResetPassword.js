...
export default function ResetPassword(_a) {
  ...
  return _jsx('div', {
    className:
      'flex flex-col items-center py-20 bg-gradient-to-br from-white to-[#b4b1d5] h-screen',
    children: _jsxs('div', {
      ...
      children: [
        ...
        actionCode && _jsx(PasswordResetForm, { setOpenToast: setOpen }),
        !actionCode && _jsx(EmailInputForReset, { setOpenToast: setOpen }),
      ],
    }),
  });
}
