...
vi.mock('universal-cookie', function () {
  return {
...
vi.mock('../../../firebase', function () {
  return {
    useAuthentication: vi.fn(function () {
      return { user: null };
    }),
  };
});
...
vi.mock('react-router-dom', function (importOriginal) {
...
describe('AuthContext', function () {
  ...
  it('should render without crashing', function () {
    var container = render(
      _jsx(BrowserRouter, { children: _jsx(AuthProvider, { children: _jsx(TestComponent, {}) }) })
    ).container;
