...
export var AuthProvider = function (_a) {
    ...
    var performTokenRefresh = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var validateToken = function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, response_1, data_1, newProfile_1, storedToken, response, data, newProfile, _error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                ...
                case 1:
                    token = _a.sent();
                    return [4 /*yield*/, fetch("".concat(getServiceURL('data'), "/api/v1/user"), {
                            headers: {
    ...
    useEffect(function () {
        if (!user || !(profile === null || profile === void 0 ? void 0 : profile.token))
            return;
        var scheduleTokenRefresh = function () {
            ...
            if (expiration) {
                ...
                var refreshTimeout_1 = setTimeout(function () { return __awaiter(void 0, void 0, void 0, function () {
                    var newToken;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, performTokenRefresh()];
                            case 1:
                                newToken = _a.sent();
                                if (!newToken) {
                                    logout();
                ...
                return function () { return clearTimeout(refreshTimeout_1); };
            }
        };
        // Schedule initial refresh
        var cleanup = scheduleTokenRefresh();
        // Also set up a backup interval every 30 minutes as a safety net
        var backupInterval = setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
