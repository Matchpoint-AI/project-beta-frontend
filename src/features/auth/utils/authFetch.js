  ...
  return __awaiter(void 0, __spreadArray([url_1], args_1, true), void 0, function (url, options) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ((_a = options.skipAuth),
            (skipAuth = _a === void 0 ? false : _a),
            (fetchOptions = __rest(options, ['skipAuth'])));
          token = getAuthToken();
...
export var serviceAuthFetch = function (service_1, path_1) {
  ...
  return __awaiter(
    void 0,
    __spreadArray([service_1, path_1], args_1, true),
    void 0,
    function (service, path, options) {
      var baseUrl, url;
      if (options === void 0) {
        options = {};
      }
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          authFetch(url, __assign(__assign({}, options), { service: service })),
        ];
      });
    }
  );
...
export var authApi = {
  get: function (url, options) {
    return authFetch(url, __assign(__assign({}, options), { method: 'GET' }));
  },
...
export var contentGenApi = {
  get: function (path, options) {
    return serviceAuthFetch(
      'content-gen',
      path,
      __assign(__assign({}, options), { method: 'GET' })
    );
  },
  post: function (path, body, options) {
    return serviceAuthFetch(
