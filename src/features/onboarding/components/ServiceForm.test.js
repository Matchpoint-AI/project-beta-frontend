...
vi.mock('./scrapeProduct', function () { return ({
    default: vi.fn(),
}); });
...
vi.mock('../../shared/components/buttons/NextButton', function () { return ({
    default: function (_a) {
        var _b = _a.text, text = _b === void 0 ? 'Next' : _b, formId = _a.formId, disabled = _a.disabled;
        return (_jsx("button", { type: "submit", form: formId, disabled: disabled, "data-testid": "next-button", children: text }));
    },
}); });
...
vi.mock('../../shared/components/ui/Dropdown', function () { return ({
    default: function (_a) {
        var options = _a.options, currentValue = _a.currentValue, onUpdateContext = _a.onUpdateContext;
        return (_jsx("select", { value: currentValue, onChange: function (e) { return onUpdateContext(e.target.value, 1); }, "data-testid": "product-dropdown", children: options.map(function (option) { return (_jsx("option", { value: option, children: option }, option)); }) }));
    },
}); });
// Mock the KeyFeatures component
vi.mock('./KeyFeatures', function () { return ({
    default: function (_a) {
        var pros = _a.pros;
        return (_jsx("div", { "data-testid": "key-features", children: pros.map(function (pro, index) { return (_jsx("div", { "data-testid": "feature-".concat(index), children: pro }, index)); }) }));
    },
}); });
// Mock the WebsiteOwnership component
vi.mock('../WebsiteOwnership', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "website-ownership" }); },
}); });
// Mock the ErrorToast component
vi.mock('../../shared/components/feedback/ErrorToast', function () { return ({
    default: function (_a) {
        var open = _a.open, onClose = _a.onClose, message = _a.message;
        return open ? (_jsx("div", { "data-testid": "error-toast", onClick: onClose, children: message })) : null;
    },
}); });
// Mock the SparklesMessage component
vi.mock('../shared/SparklesMessage', function () { return ({
...
vi.mock('../../shared/components/inputs/FormInputBox', function () { return ({
    default: function (_a) {
        var children = _a.children, styles = _a.styles, color = _a.color;
        return (_jsx("div", { className: "bg-gray-50 border rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 flex items-center justify-center gap-2", style: { borderColor: color, backgroundColor: (styles === null || styles === void 0 ? void 0 : styles.backgroundColor) || 'white' }, children: children }));
    },
}); });
describe('ServiceForm', function () {
    ...
    var renderWithProviders = function (component) {
        return render(_jsx(BrandContext.Provider, { value: { businessInfo: mockBusinessInfo, setBusinessInfo: mockSetBusinessInfo }, children: _jsx(CampaignContext.Provider, { value: { campaignInfo: mockCampaignInfo, setCampaignInfo: mockSetCampaignInfo }, children: component }) }));
    };
    beforeAll(function () {
    ...
    it('renders form with product dropdown when products exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    renderWithProviders(_jsx(ServiceForm, { handleNext: mockHandleNext, handleBack: mockHandleBack, setService: mockSetService }));
    ...
    it('renders new product form when no products exist', function () {
        ...
        render(_jsx(BrandContext.Provider, { value: { businessInfo: emptyBusinessInfo, setBusinessInfo: mockSetBusinessInfo }, children: _jsx(CampaignContext.Provider, { value: { campaignInfo: newProductCampaignInfo, setCampaignInfo: mockSetCampaignInfo }, children: _jsx(ServiceForm, { handleNext: mockHandleNext, handleBack: mockHandleBack, setService: mockSetService }) }) }));
        expect(screen.getByText(function (text) { return /service or product called/i.test(text); })).toBeInTheDocument();
        expect(screen.getAllByPlaceholderText('Name the new Product/Service')[0]).toBeInTheDocument();
    });
    it('handles product selection from dropdown', function () { return __awaiter(void 0, void 0, void 0, function () {
        var dropdown;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    dropdown = screen.getByTestId('product-dropdown');
    ...
    it('handles new product selection', function () { return __awaiter(void 0, void 0, void 0, function () {
        var dropdown;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('handles product scraping with valid URL', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles product scraping error', function () { return __awaiter(void 0, void 0, void 0, function () {
        var websiteInput, generateButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('handles form submission with valid data', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles empty product features gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
        var websiteInput, generateButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('updates business info with scraped product data', function () { return __awaiter(void 0, void 0, void 0, function () {
        var websiteInput, generateButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('shows informative button text when form is not valid', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    renderWithProviders(_jsx(ServiceForm, { handleNext: mockHandleNext, handleBack: mockHandleBack, setService: mockSetService }));
