...
var ABTestDemo = function () {
  ...
  var _b = useState(false),
    isComparisonOpen = _b[0],
    setIsComparisonOpen = _b[1];
  var _c = useState(demoTestConfig),
    demoData = _c[0],
    setDemoData = _c[1];
  ...
  var handleSaveVariant = function (variantId, content, notes) {
  ...
  var handleCreateVariant = function (variant) {
    return __awaiter(void 0, void 0, void 0, function () {
      var newVariant;
      return __generator(this, function (_a) {
        newVariant = __assign(
          {
            ...
            name: 'Variant '.concat(demoData.variants.length + 1),
            type: 'caption',
        ...
        setDemoData(function (prev) {
          return __assign(__assign({}, prev), {
            variants: __spreadArray(__spreadArray([], prev.variants, true), [newVariant], false),
          });
        });
        return [2 /*return*/];
      });
  ...
  var getWinningVariant = function () {
    return (
      demoData.variants.find(function (v) {
        return v.status === 'winner';
      }) ||
      demoData.variants.reduce(function (best, current) {
        var _a, _b;
        return (((_a = current.performance) === null || _a === void 0 ? void 0 : _a.ctr) || 0) >
          (((_b = best.performance) === null || _b === void 0 ? void 0 : _b.ctr) || 0)
          ? current
          : best;
      })
    );
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsxs(Typography, {
        ...
        children: [_jsx(FaFlask, { color: '#2196f3' }), 'A/B Test Demo - Caption Variants'],
      }),
      _jsxs(Grid, {
        container: true,
        spacing: 3,
        children: [
              ...
              children: _jsxs(CardContent, {
                children: [
                  _jsxs(Box, {
                    ...
                    children: [
                      _jsx(Typography, { variant: 'h6', children: demoData.name }),
                      _jsx(Chip, {
                  ...
                  _jsxs(Box, {
                    ...
                    children: [
                      _jsxs(Typography, {
                        variant: 'caption',
                        children: [
                          _jsx('strong', { children: 'Variants:' }),
                          ' ',
                          demoData.variants.length,
                        ],
                      }),
                      _jsxs(Typography, {
                        variant: 'caption',
                        children: [
                          _jsx('strong', { children: 'Primary Metric:' }),
                          ' ',
                          demoData.primaryMetric.toUpperCase(),
                        ],
                      }),
                      _jsxs(Typography, {
                        variant: 'caption',
                        children: [
                          _jsx('strong', { children: 'Min Sample:' }),
                          ' ',
                          demoData.minSampleSize.toLocaleString(),
                        ],
                      }),
                    ],
                  }),
                  _jsx(Button, {
                    ...
                    startIcon: _jsx(FaChartBar, {}),
                    size: 'large',
                    children: 'View A/B Test Comparison',
                  }),
                ],
              }),
            }),
          ...
          _jsx(Grid, {
            ...
            children: _jsx(Card, {
              children: _jsxs(CardContent, {
                children: [
                  _jsx(Typography, { variant: 'h6', sx: { mb: 2 }, children: 'Current Leader' }),
                  winningVariant &&
                    _jsxs(Box, {
                      children: [
                        _jsxs(Box, {
                        ...
                        _jsxs(Typography, {
                          ...
                          sx: { mb: 2 },
                          children: [
                            (_a = winningVariant.content.text) === null || _a === void 0
                              ? void 0
                              : _a.substring(0, 80),
                            '...',
                          ],
                          ...
                          _jsxs(Box, {
                            children: [
                              _jsxs(Typography, {
                                variant: 'h4',
                                color: 'primary',
                                children: [(winningVariant.performance.ctr * 100).toFixed(2), '%'],
                              }),
                              _jsx(Typography, {
                                variant: 'caption',
                              ...
                              _jsxs(Box, {
                                ...
                                children: [
                                  ...
                                  _jsxs(Typography, {
                                    variant: 'body2',
                                    children: [
                                      _jsx('strong', { children: 'Conversions:' }),
                                      ' ',
                                      winningVariant.performance.conversions,
                                    ],
                                  }),
                                ],
                              }),
          ...
          _jsxs(Grid, {
            ...
            xs: 12,
            children: [
              _jsx(Typography, { variant: 'h6', sx: { mb: 2 }, children: 'Variant Previews' }),
              _jsx(Grid, {
                container: true,
                spacing: 2,
                children: demoData.variants.map(function (variant, _index) {
                  return _jsx(
                    Grid,
                    {
                      item: true,
                            ...
                            _jsxs(Box, {
                              ...
                              children: [
                                ...
                                _jsxs(Box, {
                                  ...
                                  children: [
                                    _jsx(Chip, {
                                      label: ''.concat(variant.trafficAllocation, '%'),
                                      size: 'small',
                                      color: 'primary',
                                    }),
                            ...
                            variant.performance &&
                              _jsx(Box, {
                                children: _jsxs(Typography, {
                                  ...
                                  children: [
                                    'CTR: ',
                                    (variant.performance.ctr * 100).toFixed(2),
                                    '% | Engagement:',
                                    ' ',
