...
var SceneMixPlanner = function (_a) {
  ...
  var loadPlanAndPolicy = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var _a, planData, policyData, err_1, errorMessage;
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            err_1 = _b.sent();
            console.error('Error loading plan and policy:', err_1);
            errorMessage = 'Failed to load content plan';
            if (err_1 instanceof Error) {
              if (err_1.message.includes('404')) {
                errorMessage = 'No existing content plan found for this campaign';
              } else if (err_1.message.includes('401')) {
                errorMessage = 'Authentication failed. Please refresh the page and try again.';
              } else {
                errorMessage = 'Error loading plan: '.concat(err_1.message);
              }
            }
  ...
  var createNewPlan = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var newPolicy, newPlan, err_2, errorMessage;
        ...
        switch (_a.label) {
          ...
          case 5:
            ...
            if (err_2 instanceof Error) {
              if (err_2.message.includes('422')) {
                errorMessage = 'Invalid request parameters. Please check your campaign settings.';
              } else if (err_2.message.includes('401')) {
                errorMessage = 'Authentication failed. Please refresh the page and try again.';
              } else if (err_2.message.includes('500')) {
                errorMessage = 'Server error occurred. Please try again in a few moments.';
              } else {
                errorMessage = 'Error: '.concat(err_2.message);
              }
            }
            setError(errorMessage);
            return [3 /*break*/, 7];
