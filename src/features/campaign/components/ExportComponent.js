...
var ExportComponent = function (_a) {
  ...
  var _m = useState(false),
    loadingModalOpen = _m[0],
    setLoadingModalOpen = _m[1];
  var _o = useState(false),
    showPopup = _o[0],
    setShowPopup = _o[1]; // State for popup
  var _p = useState([
      {
      ...
      var calculateWeeks = function () {
        ...
        var numberOfWeeks =
          (_a = campaign === null || campaign === void 0 ? void 0 : campaign.campaign_data) ===
            null || _a === void 0
            ? void 0
            : _a.campaign_variables.durationNum;
        var startDate = new Date(
          ((_b = campaign === null || campaign === void 0 ? void 0 : campaign.campaign_data) ===
            null || _b === void 0
            ? void 0
            : _b.campaign_variables.start_date) || ''
        ); // Assuming start_date is in a valid date format
        var today = new Date();
        ...
        if (daysSinceStart < 0) {
          ...
          options = Array.from(
            { length: numberOfWeeks !== null && numberOfWeeks !== void 0 ? numberOfWeeks : 0 },
            function (_, i) {
              var weekNumber = i + 1;
              // Include only past weeks and the next upcoming week with one day left
              if (
                weekNumber <= currentWeek_1 ||
  ...
  var updateStep = function (index, status) {
    setSteps(function (prev) {
      return prev.map(function (step, i) {
        return i === index ? __assign(__assign({}, step), status) : step;
      });
    });
  };
  var emptyLoading = function () {
    setSteps(function (prevSteps) {
      return prevSteps.map(function (step) {
        return __assign(__assign({}, step), { loading: false, complete: false });
      });
    });
  };
  var fetchWeeksData = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var params, response, data, data2, error_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              fetch(''.concat(endpointUrl, '/api/v1/get-content?').concat(params.toString()), {
                method: 'GET',
                headers: {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
              ...
              .map(function (week) {
                ...
                return week
                  .map(function (day) {
                    ...
                    var approvedPosts = day.posts.filter(function (post) {
                  ...
                  .filter(function (day) {
                    return day !== null;
                  }); // Remove days with no approved posts
              })
          ...
          case 3:
            ...
            if (brandProfilePDF)
              bigFolder === null || bigFolder === void 0
                ? void 0
                : bigFolder.file('BrandProfile_CampaignBrief.pdf', brandProfilePDF);
          ...
          case 8:
            ...
            return [
              4 /*yield*/,
              fetch(''.concat(endpointUrl_1, '/api/v1/contentgen/track-export'), {
                method: 'POST',
                headers: {
                  Authorization: 'Bearer '.concat(
                    profile === null || profile === void 0 ? void 0 : profile.token
          ...
          case 10:
            error_2 = _a.sent();
            console.error('Error tracking exported posts:', error_2);
            return [3 /*break*/, 11];
          case 11:
            if (posthog.__loaded) {
          ...
          case 12:
            error_3 = _a.sent();
            console.error('Error during export:', error_3);
  ...
  var handleApproveAll = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var transformedWeeks, endpointUrl, response, data, error_4;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            setError('');
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch(''.concat(endpointUrl, '/api/v1/approve-all'), {
                method: 'POST',
                headers: {
                  Authorization: 'Bearer '.concat(
                    profile === null || profile === void 0 ? void 0 : profile.token
  ...
  return _jsx('div', {
    className: 'flex flex-col justify-center w-full items-center my-32 gap-6',
    children: _jsxs(_Fragment, {
      children: [
        _jsx('div', {
          ...
          children: _jsxs('div', {
            className:
              'w-[393px] p-[30px] bg-white rounded-lg shadow border border-gray-200 flex-col justify-center items-center gap-5 inline-flex',
            children: [
              _jsx('h1', {
                className: 'self-stretch text-center text-gray-900 text-xl font-semibold',
                children: 'Export Content',
              }),
              _jsx(WeekSelector, {
                options: options,
              ...
              _jsx('div', {
                ...
                children: _jsx(ExportButton, { double: double, handleExport: handleExport }),
              }),
              _jsx(ErrorDisplay, { error: error }),
            ],
          }),
        }),
        _jsx(LoadingModal, { steps: steps, isOpen: loadingModalOpen }),
        _jsx(ErrorToast, {
          message: errorText,
          open: errorSaving,
          success: success,
        ...
        showPopup &&
          _jsx(ExportPopup, {
            campaignName: capitalizeFirstLetterOfEachWord(
              ((_c =
                (_b =
                  campaign === null || campaign === void 0 ? void 0 : campaign.campaign_data) ===
                  null || _b === void 0
                  ? void 0
