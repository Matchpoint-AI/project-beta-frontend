...
describe('ModifyPrompt', function () {
  ...
  describe('splitPrompt function', function () {
    it('should handle prompts with "A realistic photograph of" prefix', function () {
      var container = render(_jsx(ModifyPrompt, __assign({}, defaultProps))).container;
  ...
  describe('prompt editing', function () {
    it('should not automatically add "A realistic photograph of" prefix', function () {
          ...
          switch (_a.label) {
            case 0:
              ...
              return [
                ...
                waitFor(function () {
                  expect(
                    screen.getByDisplayValue('Young professionals in an office')
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
    ...
    it('should handle prompts with existing content', function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var textField;
        return __generator(this, function (_a) {
          switch (_a.label) {
                  ...
                  return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                      return [
                        ...
                        {
                          prompt:
                            'A realistic photograph of young professionals. Additional content.',
                        },
                      ];
                    });
                  });
  ...
  describe('form submission', function () {
    it('should submit prompt without hardcoded prefix', function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should handle submission errors', function () {
      return __awaiter(void 0, void 0, void 0, function () {
  ...
  describe('remaining generations', function () {
    it('should fetch and display remaining generations', function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                ...
                waitFor(function () {
                  expect(
                    screen.getByText('2 Regenerations left for this post')
                  ).toBeInTheDocument();
                }),
              ];
            case 1:
    ...
    it('should disable regenerate button when no generations left', function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
