...
describe('LanguageSelector', function () {
    ...
    it('renders with custom selected language', function () {
        render(_jsx(LanguageSelector, { selectedLanguage: "es", onLanguageChange: mockOnLanguageChange }));
        var button = document.getElementById('language-selector');
        expect(button).toBeInTheDocument();
    ...
    it('opens dropdown when clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
        var button;
    ...
    it('calls onLanguageChange when a language is selected', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('handles invalid selectedLanguage by defaulting to English', function () {
        render(_jsx(LanguageSelector, { selectedLanguage: "invalid-code", onLanguageChange: mockOnLanguageChange }));
        var button = document.getElementById('language-selector');
        expect(button).toHaveTextContent('English');
    });
    it('supports all required languages', function () { return __awaiter(void 0, void 0, void 0, function () {
