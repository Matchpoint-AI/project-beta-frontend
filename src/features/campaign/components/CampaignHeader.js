...
var CampaignHeader = function (_a) {
  var title = _a.title,
    ...
    postingSchdule = _a.postingSchdule,
      ...
      children: [
        _jsxs('h1', {
          ...
          children: [
            title,
            ' ',
            _jsx('span', { children: _jsx(FaExternalLinkAlt, { className: 'w-4' }) }),
          ],
        }),
        _jsx('p', { className: 'text-sm my-1', children: Description[1] }),
        _jsxs('div', {
          children: [
            _jsxs('div', {
              className: 'flex flex-row gap-2 items-center',
              children: [
                _jsx(MdCalendarToday, {}),
                _jsxs('span', {
                  className: 'text-sm my-1 font-normal text-purple-700 underline',
                  children: ['Campaign Date: ', timeFrame],
                }),
              ],
            }),
            _jsxs('div', {
              ...
              children: [
                _jsx(GoClock, {}),
                _jsxs('span', {
                  className: 'text-sm my-1 font-normal',
                  children: ['Posting Schedule: ', postingSchdule],
                }),
              ],
            }),
            _jsxs('div', {
