      ...
      <div className="bg-white rounded-lg shadow-lg p-6 text-center flex flex-col justify-center items-center gap-3 w-[750px] h-[580px]">
        ...
        <div className="flex flex-col justify-center items-center gap-0">
          <div className="flex flex-col justify-center items-center gap-4">
            <h2 className="text-4xl font-bold text-gray-900">Congrats!</h2>
            <p className="text-xl leading-8 font-normal text-gray-900">
              You just exported your first set of Matchpoint AI-generated social media content for
              your {campaignName} campaign. Let’s keep it up!
            </p>
