    ...
    children: [
      _jsx('div', {
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsx('h1', {
              className: 'text-[#42389D] text-lg font-semibold leading-6 capitalize',
              children:
                !campaignInfo.name || campaignInfo.name === ''
                  ? 'campaign name'
                  : campaignInfo.name,
            }),
            _jsxs('p', {
              className: 'text-sm',
              children: [
                _jsx('span', { className: 'font-bold', children: 'Brand/Service/Product: ' }),
                serviceDisplay,
                ' | ',
                timingDisplay,
              ],
              ...
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsx('p', {
                      className: 'text-lg font-semibold text-[#5145CD]',
                      children: 'Campaign Creation',
                    }),
                  ],
                }),
                _jsx(StepCampaignComponent, {
                  name: 'Purpose',
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx('h1', {
                className:
                  'bg-gradient-to-r bg-clip-text font-semibold text-transparent from-[#681DBA] to-[#FF43E1] text-2xl mb-1',
                children:
                  !campaignInfo.name || campaignInfo.name === ''
                    ? 'Campaign name'
                    : campaignInfo.name,
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsxs('span', {
                    className: 'font-bold',
                    children: ['Service: ', serviceDisplay, ' | '],
                  }),
                  _jsx('span', { children: timingDisplay }),
                ],
              }),
            ],
          }),
          ...
          _jsx('div', {
            className: 'mt-5',
            children: _jsx('span', {
              className: 'font-semibold text-[#5145CD]',
              children: stepTitle[currentStep - 1],
            }),
          }),
        ],
      }),
