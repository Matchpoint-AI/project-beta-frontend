...
var PaginationImage = function (_a) {
  var currentPage = _a.currentPage,
    ...
    images = _a.images;
  return _jsx('div', {
    className: 'flex justify-center items-center h-full mt-0 text-black font-semibold',
    children: images.slice(0, 3).map(function (_, i) {
      ...
      return _jsx(
        'button',
        {
          ...
          children: isCurrent
            ? _jsxs('span', {
                className: 'block rounded-full bg-[#5145CD]/30 px-2 py-0.5',
                children: [i + 1, ' '],
              })
            : _jsxs('span', {
                className: 'block rounded-full bg-transparent px-2 py-0.5',
                children: [i + 1, ' '],
              }),
        },
        i
