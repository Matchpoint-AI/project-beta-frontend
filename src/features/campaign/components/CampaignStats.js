...
var CampaignStats = function (_a) {
  ...
  var _e = useState(0),
    weekIndex = _e[0],
    setWeekIndex = _e[1]; // Track the current week
  ...
  return _jsxs('div', {
    className: 'flex self-start flex-col gap-1 mt-2',
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('select', {
            ...
            value: weekIndex,
            onChange: function (e) {
              return setWeekIndex(parseInt(e.target.value));
            },
            children: weeksData.map(function (_, index) {
              return _jsxs('option', { value: index, children: ['Week ', index + 1] }, index);
            }),
          }),
          'Content Status',
        ],
      ...
      _jsxs('ul', {
        ...
        children: [
          _jsxs('li', {
            children: ['Ready for Review: ', readyForReview, ' out of ', totalContent],
          }),
          _jsxs('li', { children: ['Approved: ', approved, ' out of ', totalContent] }),
        ],
      }),
    ],
  });
