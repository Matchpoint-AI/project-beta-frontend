...
export default function CampaignDetails() {
    var _a = useState(null), specs = _a[0], setSpecs = _a[1];
    ...
    return (_jsxs(_Fragment, { children: [error && (_jsx("div", { className: "p-5 mb-[14px] bg-[#fff5f5] border border-[#F05252] rounded-md", children: _jsx("p", { className: "text-[#F05252] font-medium", children: "Error loading campaign details" }) })), loading && (_jsxs("div", { className: "p-5 mb-[14px] flex items-center justify-center flex-col gap-1", children: [_jsx(CircularProgress, { sx: { color: '#42389D' }, size: 25, thickness: 5 }), _jsx("p", { className: "text-[13px] capitalize text-[#6B7280]", children: "loading campaign details" })] })), specs && (_jsxs(_Fragment, { children: [specs.key_features && (_jsx(CampaignDetailsBlock, { title: "Key Competitive Features:", text: specs.key_features, review: campaignInfo.campaign_brief })), specs.audience && (_jsx(CampaignDetailsBlock, { title: "Target Audience & Interest:", text: specs.audience, review: campaignInfo.campaign_brief })), specs.purpose && (_jsx(CampaignDetailsBlock, { title: "Purpose:", text: specs.purpose, review: campaignInfo.campaign_brief }))] }))] }));
}
