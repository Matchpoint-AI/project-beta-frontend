...
var ContentPreviewPanel = function (_a) {
  var content = _a.content,
    _b = _a.platform,
    platform = _b === void 0 ? 'instagram' : _b,
    _c = _a.brandName,
    brandName = _c === void 0 ? 'Your Brand' : _c,
    ...
    onEdit = _a.onEdit,
    _e = _a.qualityScore,
    qualityScore = _e === void 0 ? 0 : _e,
    engagementPrediction = _a.engagementPrediction;
  var theme = useTheme();
  var _f = useState('split'),
    viewMode = _f[0],
    setViewMode = _f[1];
  var _g = useState(platform),
    selectedPlatform = _g[0],
    setSelectedPlatform = _g[1];
  var _h = useState('mobile'),
    deviceView = _h[0],
    setDeviceView = _h[1];
  var _j = useState(false),
    isFullscreen = _j[0],
    setIsFullscreen = _j[1];
  var _k = useState(0),
    selectedImageIndex = _k[0],
    setSelectedImageIndex = _k[1];
  var containerRef = useRef(null);
  var PlatformIcon = platformStyles[selectedPlatform].icon;
  ...
  var handleFullscreen = function () {
    ...
    if (!isFullscreen && containerRef.current) {
      (_b = (_a = containerRef.current).requestFullscreen) === null || _b === void 0
        ? void 0
        : _b.call(_a);
    ...
    return _jsxs(Box, {
      ...
      children: [
        _jsxs(Typography, {
          ...
          children: [
            _jsx(AutoAwesomeOutlinedIcon, { sx: { color: platformColor } }),
            'Content Editor',
          ],
        }),
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Typography, {
              ...
              gutterBottom: true,
              children: ['Caption (', content.text.length, '/', maxChars, ')'],
            }),
            _jsx(Paper, {
              variant: 'outlined',
              sx: {
          ...
          _jsxs(Box, {
            ...
            children: [
              ...
              _jsx(Box, {
                ...
                children: content.hashtags.map(function (tag, idx) {
                  return _jsx(
                    Chip,
                    {
                      label: tag,
                  ...
                  _jsx(Grid, {
                    ...
                    children: _jsxs(Paper, {
                      ...
                      children: [
                        ...
                        _jsx(Typography, {
                          variant: 'h6',
                          children: formatNumber(engagementPrediction.likes),
                        }),
                      ],
                    }),
                  }),
                  _jsx(Grid, {
                    ...
                    children: _jsxs(Paper, {
                      ...
                      children: [
                        ...
                        _jsx(Typography, {
                          variant: 'h6',
                          children: formatNumber(engagementPrediction.shares),
                        }),
                      ],
                    }),
                  }),
                  _jsx(Grid, {
                    ...
                    children: _jsxs(Paper, {
                      ...
                      children: [
                        ...
                        _jsx(Typography, {
                          variant: 'h6',
                          children: formatNumber(engagementPrediction.comments),
                        }),
                      ],
                    }),
                  }),
          ...
          children: _jsxs(Box, {
            ...
            children: [
              _jsx(Box, {
                ...
                children: Object.entries(platformStyles).map(function (_a) {
                  var key = _a[0],
                    style = _a[1];
                  var Icon = style.icon;
                  return _jsx(
                    IconButton,
                    {
                      size: 'small',
                      onClick: function () {
                        return setSelectedPlatform(key);
                      },
                      sx: {
              ...
              _jsxs(ButtonGroup, {
                ...
                children: [
                  _jsx(Button, {
                    onClick: function () {
                      return setDeviceView('mobile');
                    },
                    startIcon: _jsx(MdPhoneIphone, {}),
                    variant: deviceView === 'mobile' ? 'contained' : 'outlined',
                    children: 'Mobile',
                  }),
                  _jsx(Button, {
                    onClick: function () {
                      return setDeviceView('tablet');
                    },
                    startIcon: _jsx(MdTablet, {}),
                    variant: deviceView === 'tablet' ? 'contained' : 'outlined',
                    children: 'Tablet',
                  }),
                  _jsx(Button, {
                    onClick: function () {
                      return setDeviceView('desktop');
                    },
                    startIcon: _jsx(MdLaptop, {}),
                          ...
                          children: [
                            ...
                            imageUrls.length > 1 &&
                              _jsx(Box, {
                                ...
                                children: imageUrls.map(function (_, idx) {
                                  return _jsx(
                                    Box,
                                    {
                                      onClick: function () {
                                        return setSelectedImageIndex(idx);
                                      },
                                      sx: {
                                        width: 8,
                                        height: 8,
                                        borderRadius: '50%',
                                        bgcolor:
                                          idx === selectedImageIndex ? 'white' : alpha('#fff', 0.5),
                                        cursor: 'pointer',
                                      },
                                    },
                                    idx
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Typography, {
              variant: 'h6',
              sx: { display: 'flex', alignItems: 'center', gap: 1 },
              children: [_jsx(AutoAwesomeOutlinedIcon, {}), 'Enhanced Content Preview'],
            }),
            _jsxs(Box, {
              sx: { display: 'flex', gap: 1 },
              children: [
          ...
          children:
            viewMode === 'split'
              ? _jsxs(_Fragment, {
                  children: [
                    _jsx(Box, {
                      sx: { width: '40%', borderRight: 1, borderColor: 'divider' },
                      children: renderEditPanel(),
                    }),
                    _jsx(Box, { sx: { flex: 1 }, children: renderPreview() }),
                  ],
                })
              : renderPreview(),
        }),
