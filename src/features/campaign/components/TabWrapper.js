...
var TabWrapper = function (_a) {
    var currentTab = _a.currentTab, campaign = _a.campaign, setStats = _a.setStats;
    if (currentTab === '1') {
        ...
        return (_jsx(SceneMixPlanner, { campaignId: campaign.campaign_id, campaignName: campaign.campaign_data.campaign_variables.name, weeks: campaign.campaign_data.campaign_variables.durationNum, postsPerWeek: campaign.campaign_data.campaign_variables.frequency * 7 }));
    }
    else {
