...
vi.mock('../../../api/contentGenerationApi', function () {
  return {
    policyApi: {
      createPolicy: vi.fn(),
      getPolicy: vi.fn(),
...
describe('CampaignSetupCompleteDialog - Default Values', function () {
  ...
  it('should provide default values for undefined campaign fields', function () {
  ...
  it('should handle completely empty campaign info', function () {
    return __awaiter(void 0, void 0, void 0, function () {
          ...
          case 0:
            ...
            render(
              _jsx(BrandContext.Provider, {
                value: { businessInfo: businessInfo, setBusinessInfo: vi.fn() },
                children: _jsx(CampaignContext.Provider, {
                  value: { campaignInfo: {}, setCampaignInfo: vi.fn() },
                  children: _jsx(CampaignSetupCompleteDialog, {
                    setCurrentStep: vi.fn(),
                    open: true,
                  }),
...
describe('CampaignSetupCompleteDialog - Scene Mix Integration', function () {
  ...
  it.skip('should create Scene Mix plan with correct parameters', function () {
    return __awaiter(void 0, void 0, void 0, function () {
          ...
          case 0:
            ...
            ((_a = render(
              _jsx(BrandContext.Provider, {
                value: { businessInfo: businessInfo, setBusinessInfo: vi.fn() },
                children: _jsx(CampaignContext.Provider, {
                  value: { campaignInfo: campaignInfo, setCampaignInfo: vi.fn() },
                  children: _jsx(CampaignSetupCompleteDialog, {
                    setCurrentStep: vi.fn(),
                    open: true,
                  }),
              ...
              (_container = _a.container),
              (_baseElement = _a.baseElement));
  ...
  it.skip('should map campaign purposes to correct campaign types', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            render(
              _jsx(BrandContext.Provider, {
                value: { businessInfo: {}, setBusinessInfo: vi.fn() },
                children: _jsx(CampaignContext.Provider, {
                  value: { campaignInfo: campaignInfo, setCampaignInfo: vi.fn() },
                  children: _jsx(CampaignSetupCompleteDialog, {
                    setCurrentStep: vi.fn(),
  ...
  it.skip('should handle empty audience data gracefully', function () {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  it.skip('should use plan_id from response when triggering content generation', function () {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  it.skip('should fall back to legacy generation when Scene Mix fails', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            _a.sent();
            legacyCall = global.fetch.mock.calls.find(function (call) {
              return call[0].includes('/contentgen/generate') && !call[0].includes('use_scene_mix');
            });
