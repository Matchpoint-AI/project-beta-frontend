...
describe('ContentPreviewPanel', function () {
    ...
    var renderComponent = function (props) {
        ...
        return render(_jsx(ThemeProvider, { theme: theme, children: _jsx(ContentPreviewPanel, __assign({}, defaultProps, props)) }));
    };
    beforeEach(function () {
        vi.clearAllMocks();
    ...
    it('displays hashtags', function () {
        ...
        (_a = mockContent.hashtags) === null || _a === void 0 ? void 0 : _a.forEach(function (tag) {
    ...
    it('handles view mode switching', function () {
        ...
        var splitButton = buttons.find(function (btn) { var _a; return (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('Split View'); });
        var previewButton = buttons.find(function (btn) { var _a; return (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('Preview Only'); });
    ...
    it('handles device view switching', function () {
        ...
        // Find device buttons
        var buttons = screen.getAllByRole('button');
        var mobileButton = buttons.find(function (btn) { var _a; return (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('Mobile'); });
        var tabletButton = buttons.find(function (btn) { var _a; return (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('Tablet'); });
        var desktopButton = buttons.find(function (btn) { var _a; return (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('Desktop'); });
    ...
    it('calls onEdit when provided', function () {
        ...
        // Find edit button
        var buttons = screen.getAllByRole('button');
        var editButton = buttons.find(function (btn) { var _a; return (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('Edit Content'); });
        if (editButton) {
    ...
    it('does not show edit button when onEdit is not provided', function () {
        ...
        render(_jsx(ThemeProvider, { theme: theme, children: _jsx(ContentPreviewPanel, __assign({}, minimalProps)) }));
    ...
    it('handles single image', function () {
        var singleImageContent = __assign(__assign({}, mockContent), { imageUrl: 'https://example.com/single.jpg' });
