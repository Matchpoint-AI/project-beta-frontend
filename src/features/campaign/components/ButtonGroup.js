...
var ButtonGroup = function (_a) {
  var campaign = _a.campaign,
    currentTab = _a.currentTab,
    setCurrentTab = _a.setCurrentTab,
  ...
  useEffect(
    function () {
      ...
      if (campaign !== undefined) {
        ...
        setDuration(
          ((_d =
            (_c = campaign === null || campaign === void 0 ? void 0 : campaign.campaign_data) ===
              null || _c === void 0
              ? void 0
              : _c.campaign_variables) === null || _d === void 0
            ? void 0
            : _d.durationNum) || 0
        );
      }
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx(NewCardStats, { id: id, stats: stats }),
      _jsxs('div', {
        className:
          'flex flex-col-reverse md:flex-row gap-4 justify-between w-full items-end md:items-center',
        children: [
          _jsx(TabItems, {
