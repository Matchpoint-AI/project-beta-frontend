...
export default function PromptEditor(_a) {
  var _b;
  var promptsArr = _a.promptsArr,
    placeholders = _a.placeholders,
    target = _a.target,
    switchPrompts = _a.switchPrompts,
    addPrompts = _a.addPrompts;
  ...
  var _d = useState(''),
    prompt = _d[0],
    setPrompt = _d[1];
  var _e = useState(''.concat(promptsArr.length)),
    version = _e[0],
    setVersion = _e[1];
    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx('label', {
          ...
          children: target === 'scrape_website' ? 'Scrape brand website' : 'Content generation',
        }),
        _jsxs('div', {
          ...
          children: [
            _jsx('div', {
              ...
              children: placeholders.map(function (ph) {
                return _jsx(
                  'button',
                  {
                    onClick: function () {
                      return addPlaceholder(ph);
                    },
                    type: 'button',
                    className: 'bg-white py-1 px-2 text-[#03543F] text-sm rounded-md',
                    children: '{'.concat(ph, '}'),
                  },
                  ph
                );
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx(Dropdown, {
                  ...
                  options: Array.from({ length: promptsArr.length }, function (_, i) {
                    return String(i + 1);
                  }),
        ...
        error !== '' &&
          _jsx('p', { className: 'text-sm text-[#F05252] font-medium', children: error }),
        _jsxs('div', {
