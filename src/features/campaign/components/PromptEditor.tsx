    ...
    <form>
      <div className="flex flex-col gap-3 w-full">
        <label className="font-medium text-lg capitalize">
          {target === 'scrape_website' ? 'Scrape brand website' : 'Content generation'}
        </label>
        <div className="flex flex-wrap">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <Dropdown
              ...
              options={Array.from({ length: promptsArr.length }, (_, i) => String(i + 1))}
        ...
        />
        {error !== '' && <p className="text-sm text-[#F05252] font-medium">{error}</p>}
