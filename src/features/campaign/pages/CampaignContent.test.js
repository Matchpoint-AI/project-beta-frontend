...
vi.mock('../../../helpers/getServiceURL', function () { return ({
    getServiceURL: vi.fn(function () { return 'http://localhost:8080'; }),
}); });
vi.mock('../../../helpers/calculateTiming', function () { return ({
    displayDuration: vi.fn(function () { return 'Dec 1 - Dec 28, 2024'; }),
    getPostingSchedule: vi.fn(function () { return 'Daily'; }),
}); });
vi.mock('../../../helpers/formatters', function () { return ({
    capitalizeFirstLetterOfEachWord: vi.fn(function (str) { return str; }),
}); });
...
vi.mock('../../../components/shared/Sidebar', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "sidebar", children: "Sidebar" }); },
}); });
vi.mock('../components/CampaignHeader', function () { return ({
    default: function (_a) {
        var handleNavigate = _a.handleNavigate;
        return (_jsx("div", { "data-testid": "campaign-header", onClick: handleNavigate, children: "Campaign Header" }));
    },
}); });
vi.mock('../components/ButtonGroup', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "button-group", children: "Button Group" }); },
}); });
vi.mock('../components/ApprovePopup', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "approve-popup", children: "Approve Popup" }); },
}); });
vi.mock('../components/TabWrapper', function () { return ({
    default: function () { return _jsx("div", { "data-testid": "tab-wrapper", children: "Tab Wrapper" }); },
}); });
...
vi.mock('react-router-dom', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                actual = _a.sent();
                return [2 /*return*/, __assign(__assign({}, actual), { useNavigate: function () { return mockNavigate; }, useParams: function () { return ({ id: 'test-campaign-id' }); } })];
        }
    });
}); });
// Mock fetch
...
var renderWithContext = function (authValue) {
    if (authValue === void 0) { authValue = mockAuthContextValue; }
    return render(_jsx(BrowserRouter, { children: _jsx(AuthContext.Provider, { value: authValue, children: _jsx(CampaignContext.Provider, { value: mockCampaignContextValue, children: _jsx(CampaignContent, {}) }) }) }));
};
describe('CampaignContent Component', function () {
    ...
    it('should render campaign content when data is available', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should handle authentication redirect', function () {
        var unauthenticatedAuthValue = __assign(__assign({}, mockAuthContextValue), { isAuthenticated: false });
        renderWithContext(unauthenticatedAuthValue);
        expect(mockNavigate).toHaveBeenCalledWith('/login');
    });
    it('should navigate to campaign brief when header is clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
