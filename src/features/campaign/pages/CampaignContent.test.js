...
vi.mock('../components/CampaignHeader', function () {
  return {
    default: function (_a) {
...
vi.mock('../components/ButtonGroup', function () {
  return {
    default: function () {
...
vi.mock('../components/ApprovePopup', function () {
  return {
    default: function () {
...
vi.mock('../components/TabWrapper', function () {
  return {
    default: function () {
