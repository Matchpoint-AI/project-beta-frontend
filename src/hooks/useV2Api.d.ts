import type { CreateBrandRequest, UpdateBrandRequest, CrawlWebsiteRequest } from '../features/brand/api/brand-api';
/**
...
export declare function useV2Api(): {
    campaign: {
         ...
         */
        generateContent: (campaignId: string, options?: any) => Promise<import("../api/v2").GenerateContentResponse>;
        /**
    ...
    brand: {
         ...
         * Create brand
         */
        create: (data: CreateBrandRequest) => Promise<import("../api/v2").Brand>;
        /**
         * Get brand details
         */
         ...
         * Update brand
         */
        update: (brandId: string, data: Omit<UpdateBrandRequest, "brand_id">) => Promise<import("../api/v2").Brand>;
        /**
         * Delete brand
         */
         ...
         * Crawl website
         */
        crawlWebsite: (data: CrawlWebsiteRequest) => Promise<import("../api/v2").CrawlWebsiteResponse>;
        /**
         * Get brand knowledge
         */
