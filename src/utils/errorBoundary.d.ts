 ...
 */
export declare const safeAddEventListener: (element: HTMLElement | null, event: string, handler: EventListener, options?: boolean | AddEventListenerOptions) => void;
/**
 * Utility function to safely remove event listeners
 */
export declare const safeRemoveEventListener: (element: HTMLElement | null, event: string, handler: EventListener, options?: boolean | EventListenerOptions) => void;
/**
 ...
 */
export declare const safeMap: <T, R>(array: T[] | null | undefined, mapper: (item: T, index: number) => R, fallback?: R[]) => R[];
export {};
