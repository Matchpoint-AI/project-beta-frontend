...
export default function FormInput(_a) {
  var saveInput = _a.saveInput,
    subject = _a.subject,
    initValue = _a.initValue,
    validateInput = _a.validateInput,
    parentError = _a.parentError;
  var _b = useState(''),
    input = _b[0],
    setInput = _b[1];
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('label', {
        ...
        children: subject === 'name' ? 'What are you called?' : 'Add you business website',
      }),
      subject === 'website' &&
        _jsx('p', {
          className: 'text-[14px] mb-1',
          children: 'Import information on your brand, products and audience from your website',
        }),
      _jsxs('div', {
        className:
          ...
          subject === 'website' &&
            _jsx('svg', {
              ...
              children: _jsx('path', {
                ...
                stroke: ''.concat(!error ? '#6B7280' : error.error ? '#6c0404' : '#046C4E'),
                strokeWidth: '2',
