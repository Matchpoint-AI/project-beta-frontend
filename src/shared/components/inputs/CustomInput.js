...
var CustomInput = function (_a) {
    var options = _a.options, setOptions = _a.setOptions, limit = _a.limit;
    var handleChange = function (newChips) {
        if (newChips.length >= limit && limit !== -1)
            return;
        setOptions(newChips);
    };
    ...
    return (_jsx(MuiChipsInput, { className: "w-full rounded-md p-0 flex gap-2", placeholder: "", value: options, onChange: handleChange, disableEdition: true, sx: {
            ...
            var index = props.index, label = props.label;
            return (_jsx("div", { className: "ml-1", children: _jsx(Chip, { variant: "solid", style: {
                        backgroundColor: '#BCF0DA',
                        color: 'black',
                        borderRadius: '6px',
                    }, endDecorator: _jsx(ChipDelete, { variant: "plain", style: {
                            backgroundColor: '#BCF0DA',
                            color: 'gray',
                            fontSize: '1px',
                        }, onDelete: function () {
                            handleDelete(index);
                        } }), children: label }, key) }, key));
        } }));
};
