...
export default function BusinessFormInput(props) {
  ...
  var handleChange = function (e) {
    if (profile === null || profile === void 0 ? void 0 : profile.hasBrand) return;
  ...
  var clearInput = function () {
    ...
    setValue('');
    setBusinessInfo(
      __assign(__assign({}, businessInfo), ((_a = {}), (_a[props.subject] = ''), _a))
    );
    setError(true);
  };
  var saveValue = function () {
    ...
    setBusinessInfo(
      __assign(__assign({}, businessInfo), ((_a = {}), (_a[props.subject] = finalValue), _a))
    );
  };
  useEffect(
    function () {
      ...
      setError(!inputError);
      props.setFormError(function (old) {
        return {
          count: old.count + 1,
          error: !inputError,
        };
  ...
  return _jsxs('div', {
    children: [
      _jsx('h1', { className: 'mb-3 text-xl font-semibold text-gray-900', children: props.title }),
      props.description &&
        _jsx('p', { className: 'text-[14px] mb-3', children: props.description }),
      _jsxs(FormInputBox, {
        color: error === null ? '#d1d5db' : error ? '#F05252' : '#0E9F6E',
        children: [
          props.type === 'link' &&
            _jsx(LinkSymbol, { color: error === null ? '#6B7280' : error ? '#6c0404' : '#046C4E' }),
          _jsx('input', {
            value: value,
            type: 'text',
            disabled: profile === null || profile === void 0 ? void 0 : profile.hasBrand,
