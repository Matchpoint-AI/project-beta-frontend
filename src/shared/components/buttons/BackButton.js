...
var BackButton = function (_a) {
  var onClick = _a.onClick,
    _b = _a.text,
    text = _b === void 0 ? 'Back' : _b;
  return _jsxs('button', {
    type: 'button',
    className:
      'h-12 px-5 py-3 flex items-center text-[#1F2A37] border border-[#1F2A37] hover:text-[#111928] hover:border-[#111928] font-normal rounded-lg text-sm text-center me-2 mb-2',
    onClick: onClick,
    children: [
      _jsx('svg', {
