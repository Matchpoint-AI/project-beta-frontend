...
export const trackBrandProfileEdit = (field: string, isPrePopulated: boolean) => {
...
export const trackCampaignPublish = (campaignId: string, weekCount: number, totalPosts: number) => {
...
export const trackFeatureUsage = (feature: string, action: string, timeSpent?: number) => {
...
export const trackBrandProfileSession = (startTime: number, endTime: number, approved: boolean) => {
